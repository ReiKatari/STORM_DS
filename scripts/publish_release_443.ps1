# GitHub Release Publisher for STORM DS 4.4.3
param(
    [string]$TagName = "4.4.3",
    [string]$ReleaseName = "STORM DS 4.4.3",
    [string]$ApkPath = "E:\STORM DS\Files\STORM_DS_4.4.3.apk"
)
...
$bodyFile = Join-Path $PSScriptRoot "release_body_443.md"
...
Write-Host "=== Release publication 4.4.3 completed successfully! ==="
