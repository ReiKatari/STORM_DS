# GitHub Release Publisher for STORM DS 4.2.9
param(
    [string]$TagName = "4.2.9",
    [string]$ReleaseName = "STORM DS 4.2.9",
    [string]$ApkPath = "E:\STORM DS\Files\STORM_DS_4.2.9.apk"
)
...
$bodyFile = Join-Path $PSScriptRoot "release_body_429.md"
...
Write-Host "All GitHub release operations completed successfully for STORM DS 4.2.9!"
