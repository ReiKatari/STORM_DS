# GitHub Release Publisher for STORM DS 4.4.11
param(
    [string]$TagName = "4.4.11",
    [string]$ReleaseName = "STORM DS 4.4.11",
    [string]$ApkPath = "E:\STORM DS\Files\STORM_DS_4.4.11.apk"
)
...
$bodyFile = Join-Path $PSScriptRoot "release_body_4411.md"
...
Write-Host "STORM DS 4.4.11 Release process completed successfully!"
