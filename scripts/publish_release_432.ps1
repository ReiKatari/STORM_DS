# GitHub Release Publisher for STORM DS 4.3.2
param(
    [string]$TagName = "4.3.2",
    [string]$ReleaseName = "STORM DS 4.3.2",
    [string]$ApkPath = "E:\STORM DS\Files\STORM_DS_4.3.2.apk"
)
...
$bodyFile = Join-Path $PSScriptRoot "release_body_432.md"
...
Write-Host "=== Release publication 4.3.2 completed successfully! ==="
