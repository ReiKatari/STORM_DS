# GitHub Release Publisher for STORM DS 4.4.8
param(
    [string]$TagName = "4.4.8",
    [string]$ReleaseName = "STORM DS 4.4.8",
    [string]$ApkPath = "E:\STORM DS\Files\STORM_DS_4.4.8.apk"
)
...
$bodyFile = Join-Path $PSScriptRoot "release_body_448.md"
...
Write-Host "=== Release publication 4.4.8 completed successfully! ==="
