# GitHub Release Publisher for STORM DS 4.3.1
param(
    [string]$TagName = "4.3.1",
    [string]$ReleaseName = "STORM DS 4.3.1",
    [string]$ApkPath = "E:\STORM DS\Files\STORM_DS_4.3.1.apk"
)
...
$bodyFile = Join-Path $PSScriptRoot "release_body_431.md"
...
Write-Host "=== Release publication 4.3.1 completed successfully! ==="