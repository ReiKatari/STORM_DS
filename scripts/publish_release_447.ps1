# GitHub Release Publisher for STORM DS 4.4.7
param(
    [string]$TagName = "4.4.7",
    [string]$ReleaseName = "STORM DS 4.4.7",
    [string]$ApkPath = "E:\STORM DS\Files\STORM_DS_4.4.7.apk"
)
...
$bodyFile = Join-Path $PSScriptRoot "release_body_447.md"
...
Write-Host "=== Release publication 4.4.7 completed successfully! ==="
