...
public class AlertDialogLayout extends bo3 {
        ...
        if (mode2 != 1073741824) {
            ...
            while (i13 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) ao3Var).width == -1) {
                        int i14 = ((LinearLayout.LayoutParams) ao3Var).height;
                        ((LinearLayout.LayoutParams) ao3Var).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, makeMeasureSpec2, 0, i12, 0);
                        ((LinearLayout.LayoutParams) ao3Var).height = i14;
                    }
                }
                i13++;
