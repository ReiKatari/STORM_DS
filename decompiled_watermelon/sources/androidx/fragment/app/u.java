...
public abstract class u {
    ...
    /* JADX WARN: Type inference failed for: r0v14, types: [k91, java.lang.Object] */
    /* JADX WARN: Type inference failed for: r0v16, types: [eg2] */
    /* JADX WARN: Type inference failed for: r0v17, types: [eg2] */
    /* JADX WARN: Type inference failed for: r0v18, types: [eg2] */
    /* JADX WARN: Type inference failed for: r0v19, types: [eg2] */
    public u() {
        ...
        this.q = new wz0(this) { // from class: eg2
        ...
        this.r = new wz0(this) { // from class: eg2
            public final /* synthetic */ u b;
        ...
        this.s = new wz0(this) { // from class: eg2
            public final /* synthetic */ u b;
        ...
        this.t = new wz0(this) { // from class: eg2
            public final /* synthetic */ u b;
        ...
        this.P = new es4(10, this);
    }

    public static HashSet F(a aVar) {
        HashSet hashSet = new HashSet();
        for (int i = 0; i < aVar.c.size(); i++) {
            o oVar = ((vg2) aVar.c.get(i)).b;
            if (oVar != null && aVar.i) {
                hashSet.add(oVar);
            }
        }
            ...
            if (i10 < i2) {
                ...
                if (!booleanValue) {
                    ...
                    while (i12 < arrayList6.size()) {
                        vg2 vg2Var = (vg2) arrayList6.get(i12);
                        boolean z6 = z4;
                        int i13 = vg2Var.a;
                        if (i13 != i11) {
                            i5 = i10;
                            if (i13 != 2) {
                                if (i13 != 3 && i13 != 6) {
                                    if (i13 != 7) {
                                        if (i13 == 8) {
                                            arrayList6.add(i12, new vg2(9, oVar, 0));
                                            vg2Var.c = true;
                                            i12++;
                                            oVar = vg2Var.b;
                                        }
                                    ...
                                    arrayList5.remove(vg2Var.b);
                                    o oVar2 = vg2Var.b;
                                    if (oVar2 == oVar) {
                                        arrayList6.add(i12, new vg2(oVar2, 9));
                                        i12++;
                                        z3 = z5;
                                        oVar = null;
                                        i6 = 1;
                                    ...
                                    if (oVar4.mContainerId == i14) {
                                        if (oVar4 == oVar3) {
                                            ...
                                            if (oVar4 == oVar) {
                                                i7 = i14;
                                                i8 = 0;
                                                arrayList6.add(i12, new vg2(9, oVar4, 0));
                                                i12++;
                                                oVar = null;
                                            } else {
                                                i7 = i14;
                                            ...
                                            vg2 vg2Var2 = new vg2(3, oVar4, i8);
                                            vg2Var2.d = vg2Var.d;
                                            vg2Var2.f = vg2Var.f;
                                            vg2Var2.e = vg2Var.e;
                                            vg2Var2.g = vg2Var.g;
                                            arrayList6.add(i12, vg2Var2);
                    ...
                    while (size2 >= 0) {
                        vg2 vg2Var3 = (vg2) arrayList7.get(size2);
                        int i17 = vg2Var3.a;
                        if (i17 != i16) {
                            if (i17 != 3) {
                                switch (i17) {
                            ...
                            arrayList5.add(vg2Var3.b);
                            size2--;
                            i16 = 1;
                        }
                        arrayList5.remove(vg2Var3.b);
                        size2--;
                        i16 = 1;
                    }
                }
                ...
                while (i20 < i2) {
                    ...
                    if (((Boolean) arrayList2.get(i20)).booleanValue()) {
                        ...
                        for (int size4 = arrayList9.size() - 1; size4 >= 0; size4--) {
                            vg2 vg2Var4 = (vg2) arrayList9.get(size4);
                            o oVar6 = vg2Var4.b;
                            if (oVar6 != null) {
                            ...
                            switch (vg2Var4.a) {
                                case 1:
                                    oVar6.setAnimations(vg2Var4.d, vg2Var4.e, vg2Var4.f, vg2Var4.g);
                                    z11 = true;
                                    uVar.Y(oVar6, true);
                                    uVar.T(oVar6);
                                    break;
                                ...
                                case 9:
                                    ...
                                    break;
                                case 10:
                                    vg2Var4.i = oVar6.mMaxState;
                                    uVar.Z(oVar6, vg2Var4.h);
                                    z11 = true;
                                    break;
                            }
                        }
                        ...
                        int i24 = 0;
                        while (i24 < size5) {
                            vg2 vg2Var5 = (vg2) arrayList10.get(i24);
                            o oVar7 = vg2Var5.b;
                            if (oVar7 != null) {
                            ...
                            switch (vg2Var5.a) {
                                case 1:
                                    i3 = i20;
                                    oVar7.setAnimations(vg2Var5.d, vg2Var5.e, vg2Var5.f, vg2Var5.g);
                                    uVar2.Y(oVar7, false);
                                    uVar2.a(oVar7);
                                    break;
                                case 2:
                                default:
                                    f81.e(vg2Var5.a, "Unknown cmd: ");
                                    return;
                                case 3:
                                    i3 = i20;
                                    oVar7.setAnimations(vg2Var5.d, vg2Var5.e, vg2Var5.f, vg2Var5.g);
                                ...
                                case 9:
                                    ...
                                    break;
                                case 10:
                                    vg2Var5.h = oVar7.mMaxState;
                                    uVar2.Z(oVar7, vg2Var5.i);
                                    i3 = i20;
                                    break;
                            }
                            i24++;
                ...
                for (int i28 = i9; i28 < i2; i28++) {
                    ...
                    if (booleanValue2) {
                        for (int size9 = aVar3.c.size() - 1; size9 >= 0; size9--) {
                            o oVar10 = ((vg2) aVar3.c.get(size9)).b;
                            if (oVar10 != null) {
                                g(oVar10).k();
                            }
                        }
                ...
                if (z10) {
                    for (int i31 = 0; i31 < arrayList11.size(); i31++) {
                        s16 s16Var3 = (s16) arrayList11.get(i31);
                        switch (s16Var3.a) {
                            case 0:
                                SettingsActivity settingsActivity = s16Var3.b;
                                int i32 = SettingsActivity.E0;
                                settingsActivity.D();
                                break;
                            default:
                                SettingsActivity settingsActivity2 = s16Var3.b;
                                r9 r9Var = settingsActivity2.D0;
                                if (r9Var != null) {
                                    ((ConstraintLayout) r9Var.a).post(new tm3(8, settingsActivity2));
                                    break;
                                } else {
                                    b53.g0("binding");
                                    throw null;
    ...
    public final ViewGroup G(o oVar) {
        ...
        if (oVar.mContainerId > 0 && this.x.e()) {
            View d = this.x.d(oVar.mContainerId);
    ...
    public final void O(int i, boolean z) {
        ...
        if (this.w == null && i != -1) {
            ...
            if (this.G && (dg2Var = this.w) != null && this.v == 7) {
                ((wf2) dg2Var).X.invalidateOptionsMenu();
                this.G = false;
            }
        }
    }
    ...
    public final void U(ArrayList arrayList, ArrayList arrayList2) {
        if (!arrayList.isEmpty()) {
            ...
            defpackage.i.n("Internal error with the back stack records");
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r14v1, types: [vg2, java.lang.Object] */
    public final void V(Bundle bundle) {
        ...
        ng2 ng2Var = (ng2) bundle.getParcelable("state");
        if (ng2Var == null) {
            return;
        }
        hashMap3.clear();
        ArrayList arrayList = ng2Var.A;
        int size = arrayList.size();
        int i3 = 0;
        while (true) {
            k91Var = this.o;
            ...
            if (i4 != null) {
                ...
                if (oVar != null) {
                    ...
                    xVar = new x(k91Var, yVar, oVar, i4);
                    bundle2 = i4;
                } else {
                    i2 = 2;
                    bundle2 = i4;
        ...
        while (i5 < size2) {
            ...
            if (hashMap3.get(oVar3.mWho) == null) {
                if (K(2)) {
                    Log.v("FragmentManager", "Discarding retained Fragment " + oVar3 + " that was not found in the set of active Fragments " + ng2Var.A);
                }
                this.O.i(oVar3);
                oVar3.mFragmentManager = this;
                x xVar2 = new x(k91Var, yVar, oVar3);
                xVar2.e = 1;
                xVar2.k();
        ...
        if (arrayList3 != null) {
            ...
            while (i6 < size3) {
                ...
                if (b != null) {
                    ...
                    defpackage.i.n(wh1.A("No instantiated fragment for (", str3, ")"));
                    return;
                }
            }
        }
        if (ng2Var.L != null) {
            this.d = new ArrayList(ng2Var.L.length);
            int i7 = 0;
            while (true) {
                b[] bVarArr = ng2Var.L;
                ...
                while (i8 < iArr.length) {
                    ...
                    obj4.h = qm3.values()[bVar.L[i9]];
                    obj4.i = qm3.values()[bVar.R[i9]];
                    int i11 = i8 + 2;
                    if (iArr[i10] != 0) {
                        z = true;
                    } else {
                ...
                for (int i17 = 0; i17 < arrayList4.size(); i17++) {
                    ...
                    if (str4 != null) {
                        ((vg2) aVar.c.get(i17)).b = yVar.b(str4);
                    }
                }
                aVar.d(1);
                if (K(2)) {
                    StringBuilder s = wh1.s("restoreAllState: back stack #", i7, " (index ");
                    s.append(aVar.v);
                    s.append("): ");
                    s.append(aVar);
        ...
        this.k.set(ng2Var.R);
        String str5 = ng2Var.X;
        if (str5 != null) {
            o b2 = yVar.b(str5);
            this.z = b2;
            r(b2);
        }
        ArrayList arrayList5 = ng2Var.Y;
        if (arrayList5 != null) {
            for (int i18 = i; i18 < arrayList5.size(); i18++) {
                this.l.put((String) arrayList5.get(i18), (uy) ng2Var.Z.get(i18));
            }
        }
        this.F = new ArrayDeque(ng2Var.c0);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r3v8, types: [android.os.Parcelable, ng2, java.lang.Object] */
        ...
        if (hashMap2.isEmpty()) {
            ...
            if (size2 > 0) {
                ...
                for (i = 0; i < size2; i++) {
                    ...
                    if (K(2)) {
                        StringBuilder s = wh1.s("saveAllState: adding back stack #", i, ": ");
            ...
            obj2.c0 = new ArrayList(this.F);
            bundle.putParcelable("state", obj2);
            for (String str : this.m.keySet()) {
                bundle.putBundle(b31.p("result_", str), (Bundle) this.m.get(str));
            }
            for (String str2 : hashMap2.keySet()) {
                bundle.putBundle(b31.p("fragment_", str2), (Bundle) hashMap2.get(str2));
            }
        }
        return bundle;
    }
    ...
    public final void Z(o oVar, qm3 qm3Var) {
        if (oVar.equals(this.c.b(oVar.mWho)) && (oVar.mHost == null || oVar.mFragmentManager == this)) {
            oVar.mMaxState = qm3Var;
        } else {
            vd6.g("Fragment ", oVar, " is not an active fragment of FragmentManager ", this);
        }
    }
    ...
    public final void b(dg2 dg2Var, ag2 ag2Var, o oVar) {
        boolean z;
        String str;
        if (this.w == null) {
            this.w = dg2Var;
            ...
            if (oVar != null) {
                copyOnWriteArrayList.add(new ig2(oVar));
            } else if (dg2Var instanceof pg2) {
                copyOnWriteArrayList.add((pg2) dg2Var);
            }
            if (this.y != null) {
                e0();
            }
            if (dg2Var instanceof lc4) {
                lc4 lc4Var = (lc4) dg2Var;
                kc4 b = lc4Var.b();
                this.g = b;
                fn3 fn3Var = lc4Var;
                if (oVar != null) {
            ...
            if (oVar != null) {
                ...
                this.O = vVar2;
            } else if (dg2Var instanceof ab7) {
                za7 viewModelStore = ((ab7) dg2Var).getViewModelStore();
                viewModelStore.getClass();
                x31 x31Var = x31.b;
                x31Var.getClass();
                q9 q9Var = new q9(viewModelStore, v.h, x31Var);
                qo0 a = q75.a(v.class);
                String b2 = a.b();
                if (b2 != null) {
                    this.O = (v) q9Var.F(a, "androidx.lifecycle.ViewModelProvider.DefaultKey:".concat(b2));
                } else {
            ...
            this.c.d = vVar3;
            dg2 dg2Var2 = this.w;
            if ((dg2Var2 instanceof au5) && oVar == null) {
                xt5 savedStateRegistry = ((au5) dg2Var2).getSavedStateRegistry();
                savedStateRegistry.c("android:support:fragments", new ss0(3, this));
            ...
            dg2 dg2Var3 = this.w;
            if (dg2Var3 instanceof k9) {
                i9 l = ((k9) dg2Var3).l();
                if (oVar != null) {
                    str = b31.q(new StringBuilder(), oVar.mWho, ":");
                } else {
                    str = "";
                }
                String concat = "FragmentManager:".concat(str);
                this.C = l.c(concat.concat("StartActivityForResult"), new b9(4), new fg2(this, 1));
                this.D = l.c(concat.concat("StartIntentSenderForResult"), new b9(6), new fg2(this, 2));
                this.E = l.c(concat.concat("RequestPermissions"), new b9(2), new fg2(this, 0));
            }
            dg2 dg2Var4 = this.w;
            if (dg2Var4 instanceof mc4) {
                ((mc4) dg2Var4).f(this.q);
            }
            dg2 dg2Var5 = this.w;
            if (dg2Var5 instanceof ad4) {
                ((ad4) dg2Var5).k(this.r);
            }
            dg2 dg2Var6 = this.w;
            if (dg2Var6 instanceof sc4) {
                ((sc4) dg2Var6).i(this.s);
            }
            dg2 dg2Var7 = this.w;
            if (dg2Var7 instanceof tc4) {
                ((tc4) dg2Var7).h(this.t);
            }
            dg2 dg2Var8 = this.w;
            if ((dg2Var8 instanceof xw3) && oVar == null) {
                ((xw3) dg2Var8).j(this.u);
                return;
            }
            return;
        }
        defpackage.i.n("Already attached");
    }
    ...
    public final void d0(IllegalStateException illegalStateException) {
        ...
        if (dg2Var != null) {
            try {
                ((wf2) dg2Var).X.dump("  ", null, printWriter, new String[0]);
            } catch (Exception e) {
    ...
    public final void l() {
        ...
        w();
        dg2 dg2Var = this.w;
        boolean z2 = dg2Var instanceof ab7;
        y yVar = this.c;
        if (z2) {
            z = yVar.d.f;
        } else {
            xp xpVar = dg2Var.B;
            if (xpVar != null) {
                z = true ^ xpVar.isChangingConfigurations();
            }
        }
        if (z) {
            for (uy uyVar : this.l.values()) {
        ...
        u(-1);
        dg2 dg2Var2 = this.w;
        if (dg2Var2 instanceof ad4) {
            ((ad4) dg2Var2).m(this.r);
        }
        dg2 dg2Var3 = this.w;
        if (dg2Var3 instanceof mc4) {
            ((mc4) dg2Var3).g(this.q);
        }
        dg2 dg2Var4 = this.w;
        if (dg2Var4 instanceof sc4) {
            ((sc4) dg2Var4).o(this.s);
        }
        dg2 dg2Var5 = this.w;
        if (dg2Var5 instanceof tc4) {
            ((tc4) dg2Var5).n(this.t);
        }
        dg2 dg2Var6 = this.w;
        if ((dg2Var6 instanceof xw3) && this.y == null) {
            ((xw3) dg2Var6).c(this.u);
        }
        this.w = null;
        this.x = null;
        this.y = null;
    ...
    public final String toString() {
        ...
        if (oVar != null) {
            ...
            dg2 dg2Var = this.w;
            if (dg2Var != null) {
                sb.append(dg2Var.getClass().getSimpleName());
                sb.append("{");
            ...
            try {
                ...
                if (size4 > 0) {
                    ...
                    for (int i4 = 0; i4 < size4; i4++) {
                        ...
                        printWriter.print(": ");
                        printWriter.println((kg2) this.a.get(i4));
                    }
                }
            } catch (Throwable th) {
                throw th;
    ...
    public final void x(kg2 kg2Var, boolean z) {
        if (!z) {
            if (this.w == null) {
                if (this.J) {
                    defpackage.i.n("FragmentManager has been destroyed");
                    return;
                } else {
                    defpackage.i.n("FragmentManager has not been attached to a host.");
                    return;
                }
            } else if (this.H || this.I) {
                defpackage.i.n("Can not perform this action after onSaveInstanceState");
                return;
            }
        }
        synchronized (this.a) {
    ...
    public final void y(boolean z) {
        if (!this.b) {
            if (this.w == null) {
                ...
                defpackage.i.n("Must be called from main thread of fragment host");
                return;
            }
        }
        defpackage.i.n("FragmentManager is already executing transactions");
    }
            ...
            synchronized (this.a) {
                if (this.a.isEmpty()) {
                    ...
                    while (true) {
                        ...
                        z2 |= ((kg2) arrayList.get(i2)).a(arrayList3, arrayList4);
                        i2++;
                    }
                    arrayList.clear();
                    this.w.L.removeCallbacks(this.P);
