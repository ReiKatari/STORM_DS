...
public final class wn3 implements LineHeightSpan {
    ...
    public wn3(float f, int i, boolean z, boolean z2, float f2, int i2) {
        this.A = f;
        this.B = i;
        this.L = z;
        this.R = z2;
        this.X = f2;
        this.Y = i2;
        if ((RecyclerView.A1 <= f2 && f2 <= 1.0f) || f2 == -1.0f) {
            return;
        }
            ...
            if (this.Z == Integer.MIN_VALUE) {
                ...
                if (i9 == 1 && i11 <= 0) {
                    ...
                    if (i9 == 0 || i11 >= 0) {
                        ...
                        this.e0 = i16;
                        this.f0 = fontMetricsInt.ascent - i17;
                        this.g0 = i16 - i15;
                    } else if (i9 == 2) {
