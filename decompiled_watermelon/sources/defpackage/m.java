...
public final class m extends InputStream {
    ...
    public m(InputStream inputStream, cq0 cq0Var, String str, byte[] bArr) {
        this.A = inputStream;
        this.B = cq0Var;
        this.L = str;
        this.R = bArr;
        ...
        if (bArr != null) {
            if (bArr.length >= 2) {
                ...
                if (i8 + i6 <= bArr.length) {
                    ...
                    System.arraycopy(cq0Var.d, i8, bArr3, 0, i6);
                    byte[] bArr4 = this.R;
                    if (bArr4 != null) {
                        if (i4 == 63) {
                            digest = new byte[32];
                    ...
                    throw new IOException(wh1.A("Cannot read encrypted content from ", str, " without a password."));
                }
                f81.j(b31.p("Salt size + IV size too long in ", str));
                return null;
            }
            f81.j(b31.p("AES256 properties too short in ", str));
            return null;
        }
        f81.j(b31.p("Missing AES256 properties in ", str));
        return null;
    }
