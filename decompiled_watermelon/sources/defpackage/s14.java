                ...
                if (this.f != 0 || ((this.a[b >> 3] >> ((b & 7) << 3)) & 255) == 254) {
                        ...
                        if (Long.compare((this.e * 32) ^ Long.MIN_VALUE, (i20 * 25) ^ Long.MIN_VALUE) <= 0) {
                            ...
                            while (i27 != i22) {
                                ...
                                if (j12 == 128 || j12 != 254) {
                                    ...
                                    int i32 = i31 & i22;
                                    long j13 = j11;
                                    if (((b2 - i32) & i22) / 8 == ((i27 - i32) & i22) / i25) {
                                        ...
                                        if (((j14 >> i35) & j) == 128) {
                                            i5 = i22;
                                            objArr = objArr2;
                                            jArr4[i34] = ((~(j << i35)) & j14) | ((i4 & 127) << i35);
                                            jArr4[i28] = (jArr4[i28] & (~(j << i29))) | (128 << i29);
                                            objArr[b2] = objArr[i27];
                                            objArr[i27] = null;
                                            iArr[b2] = iArr[i27];
                                            iArr[i27] = 0;
                                        } else {
                                            i5 = i22;
                                            objArr = objArr2;
                                            jArr4[i34] = ((i4 & 127) << i35) | ((~(j << i35)) & j14);
                    ...
                    while (i39 < i37) {
                        if (((jArr5[i39 >> 3] >> ((i39 & 7) << 3)) & 255) < 128) {
                            ...
                            int i42 = b4 >> 3;
                            int i43 = (b4 & 7) << 3;
                            long j16 = (jArr[i42] & (~(255 << i43))) | (j15 << i43);
                            jArr[i42] = j16;
                            jArr[(((b4 - 7) & i38) + (i38 & 7)) >> 3] = j16;
                            objArr4[b4] = obj4;
                            iArr3[b4] = iArr2[i39];
                        } else {
                            jArr = jArr6;
