...
public final class vo1 implements InputFilter {
    public final TextView a;
    public uo1 b;

    public vo1(TextView textView) {
        this.a = textView;
    }
    ...
    */
    public final java.lang.CharSequence filter(java.lang.CharSequence r4, int r5, int r6, android.text.Spanned r7, int r8, int r9) {
        ...
        L58:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vo1.filter(java.lang.CharSequence, int, int, android.text.Spanned, int, int):java.lang.CharSequence");
    }
}
