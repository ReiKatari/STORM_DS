...
public final class s30 extends z44 {
    public final /* synthetic */ int q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ s30(int i, boolean z) {
        super(z);
        this.q = i;
    }
            ...
            case 0:
                if (!str.equals("true")) {
                    if (str.equals("false")) {
                        ...
                        i.i("A boolean NavType only accepts \"true\" or \"false\" values.");
                        return null;
                    }
                }
                return Boolean.valueOf(z);
