...
public final class cf1 extends o0 implements bc4 {
    ...
    public cf1(Context context, Window window) {
        super(context, null);
        this.h0 = window;
        this.i0 = me2.G(ft0.a);
        WeakHashMap weakHashMap = aa7.a;
        s97.c(this, this);
        aa7.p(this, new bf1(this));
    }
    ...
    public final void a(tu0 tu0Var, int i) {
        ...
        if (sk2Var.O(i3 & 1, z)) {
            ((aj2) this.i0.getValue()).j(sk2Var, 0);
        } else {
            sk2Var.R();
        }
        m55 r = sk2Var.r();
    ...
    */
    public final void h(int r13, int r14) {
        ...
        Lb:
            ...
            r9 = 30
            if (r8 >= r9) goto L3b
            zo r8 = defpackage.zo.a
            int r8 = r8.a(r6)
            goto L4a
        L3b:
            r9 = 32
            if (r8 >= r9) goto L49
            gp r8 = defpackage.gp.a
            int r8 = r8.a(r6)
            goto L4a
        L46:
            int r8 = r3 + 1
        ...
        Lc7:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cf1.h(int, int):void");
    }
}
