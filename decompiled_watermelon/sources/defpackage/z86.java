...
public final class z86 {
    ...
    public z86(w86 w86Var) {
        this.a = w86Var;
        int[] iArr = w86Var.A;
        this.b = iArr;
        Object[] objArr = w86Var.L;
        this.c = objArr;
        this.d = w86Var.d0;
        this.e = w86Var.e0;
        this.f = w86Var.f0;
    ...
    public static void z(z86 z86Var) {
        int i = z86Var.v;
        int r = z86Var.r(i);
        int[] iArr = z86Var.b;
        int i2 = (r * 5) + 1;
        ...
        if ((i3 & 134217728) == 0) {
            ...
            z86Var.T(z86Var.E(iArr, i));
        }
    }

    public final void A(w86 w86Var, int i) {
        if (this.n <= 0) {
            xu0.a("Check failed");
        }
        if (i == 0 && this.t == 0 && this.a.B == 0) {
            ...
            if (i2 == i3) {
                ...
                j14 j14Var = this.f;
                Object[] objArr2 = w86Var.L;
                int i4 = w86Var.R;
                HashMap hashMap2 = w86Var.e0;
                j14 j14Var2 = w86Var.f0;
                this.b = iArr;
                this.c = objArr2;
                this.d = w86Var.d0;
                this.g = i3;
        ...
        z86 i5 = w86Var.i();
        try {
            jk2.K(i5, i, this, true, true, false);
            i5.e(true);
        } catch (Throwable th) {
            i5.e(false);
            throw th;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x0065, code lost:
        defpackage.nu.d0(r4 + r3, r3, r5, r2, r2);
     */
    /* JADX WARN: Code restructure failed: missing block: B:26:0x006a, code lost:
        defpackage.nu.d0(r5, r5 + r4, r3 + r4, r2, r2);
     */
    /*
    ...
    */
    public final void B(int r9) {
        /*
            ...
            java.util.ArrayList r2 = r8.d
            if (r1 >= r9) goto L39
            int r2 = defpackage.y86.a(r2, r1, r3)
        L1d:
            ...
            goto L1d
        L39:
            int r2 = defpackage.y86.a(r2, r9, r3)
        L3d:
            java.util.ArrayList r4 = r8.d
            int r4 = r4.size()
            if (r2 >= r4) goto L59
        ...
        L59:
            ...
            if (r9 >= r1) goto L6a
            int r4 = r4 + r3
            defpackage.nu.d0(r4, r3, r5, r2, r2)
            goto L70
        L6a:
            int r6 = r5 + r4
            int r3 = r3 + r4
            defpackage.nu.d0(r5, r6, r3, r2, r2)
        L70:
            if (r9 >= r1) goto L74
            int r1 = r9 + r0
        L74:
        ...
        Lab:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.z86.B(int):void");
    }
        ...
        if (i5 != min) {
            ...
            if (min < i5) {
                ...
                while (r < r2) {
                    ...
                    int i9 = this.b[i8];
                    if (i9 < 0) {
                        xu0.a("Unexpected anchor value, expected a positive anchor");
                    }
                ...
                while (r3 < r4) {
                    ...
                    int i11 = this.b[i10];
                    if (i11 >= 0) {
                        xu0.a("Unexpected anchor value, expected a negative anchor");
                    }
    ...
    public final Object F(Object obj) {
        ...
        if (this.i > this.j) {
            xu0.a("Writing to an invalid slot");
        }
    ...
    public final boolean H() {
        if (this.n != 0) {
            xu0.a("Cannot remove group while inserting");
        }
        int i = this.t;
        int i2 = this.i;
        int g = g(this.b, r(i));
    ...
    public final boolean I(int i, int i2) {
        ...
        if (i2 > 0) {
            ...
            if (!arrayList.isEmpty()) {
                HashMap hashMap = this.e;
                int i3 = i + i2;
                int a = y86.a(this.d, i3, o() - this.h);
                if (a >= this.d.size()) {
                    a--;
                }
                int i4 = a + 1;
                ...
                while (a >= 0) {
                    ...
                    if (c < i3) {
                        ...
                        if (hashMap != null) {
                            uk2 uk2Var = (uk2) hashMap.remove(mk2Var);
                        }
                        if (i5 == 0) {
                            i5 = a + 1;
                        }
    ...
    public final Object K(int i, int i2, Object obj) {
        ...
        int i3 = N + i2;
        if (i3 < N || i3 >= g) {
            xu0.a("Write to an invalid slot index " + i2 + " for group " + i);
        }
        int h = h(i3);
        Object[] objArr = this.c;
    ...
    public final uk2 O(int i) {
        mk2 R;
        HashMap hashMap = this.e;
        if (hashMap == null || (R = R(i)) == null) {
            return null;
        }
        return (uk2) hashMap.get(R);
    }

    public final void P() {
        if (this.n != 0) {
            xu0.a("Key must be supplied when inserting");
        }
        sn1 sn1Var = su0.a;
        Q(0, sn1Var, sn1Var, false);
    }
    ...
    public final mk2 R(int i) {
        ArrayList arrayList;
        int e;
        if (i < 0 || i >= p() || (e = y86.e((arrayList = this.d), i, p())) < 0) {
            return null;
        }
    ...
    public final void S(Object obj) {
        ...
        if ((this.b[i] & 268435456) == 0) {
            xu0.a("Updating the data of a group that was not created with a data slot");
        }
        Object[] objArr = this.c;
        int[] iArr = this.b;
    ...
    public final void U(int i, Object obj) {
        ...
        if (r >= iArr.length || (iArr[(r * 5) + 1] & 1073741824) == 0) {
            xu0.a("Updating the node of a group at " + i + " that was not created with as a node group");
        }
    ...
    public final void a(int i) {
        if (i < 0) {
            xu0.a("Cannot seek backwards");
        }
        if (this.n > 0) {
            or4.b("Cannot call seek() while inserting");
        }
        if (i == 0) {
            return;
        }
        ...
        if (i2 < this.v || i2 > this.u) {
            xu0.a("Cannot seek outside the current group (" + this.v + '-' + this.u + ')');
        }
        this.t = i2;
        int g = g(this.b, r(i2));
        this.i = g;
    ...
    public final void j() {
        ...
        if (z) {
            j14 j14Var = this.s;
            if (j14Var != null && (w14Var = (w14) j14Var.b(i5)) != null) {
                Object[] objArr = w14Var.a;
                int i10 = w14Var.b;
                for (int i11 = 0; i11 < i10; i11++) {
                    F(objArr[i11]);
                }
                w14 w14Var2 = (w14) j14Var.g(i5);
            }
            int[] iArr = this.b;
            iArr[i8 + 3] = i7;
            y86.c(r2, i6, iArr);
        ...
        if (i3 != i4) {
            xu0.a("Expected to be at the end of a group");
        }
        int[] iArr2 = this.b;
        int i12 = i8 + 3;
        int i13 = iArr2[i12];
        ...
        if (i15 != 0 || i != 0) {
            while (E2 != 0 && E2 != b2 && (i != 0 || i15 != 0)) {
                ...
                if (i != 0) {
                    int[] iArr4 = this.b;
                    y86.c(r3, (iArr4[(r3 * 5) + 1] & 67108863) + i, iArr4);
                }
                int[] iArr5 = this.b;
    ...
    public final void k() {
        if (this.n <= 0) {
            or4.b("Unbalanced begin/end insert");
        }
        int i = this.n - 1;
        this.n = i;
        if (i == 0) {
            if (this.r.b != this.p.b) {
                xu0.a("startGroup/endGroup mismatch while inserting");
            }
            this.u = (o() - this.h) - this.q.b();
        }
    }
    ...
    public final void l(int i) {
        ...
        if (!z) {
            xu0.a("Cannot call ensureStarted() while inserting");
        }
        int i2 = this.v;
        if (i2 != i) {
            if (i >= i2 && i < this.u) {
            ...
            if (!z2) {
                xu0.a("Started group at " + i + " must be a subgroup of the group at " + i2);
            }
            int i3 = this.t;
            int i4 = this.i;
            int i5 = this.j;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void n(int r20, defpackage.aj2 r21) {
        /*
            Method dump skipped, instructions count: 330
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.z86.n(int, aj2):void");
    }
    ...
    public final boolean v(int i, int i2) {
        ...
        if (i2 == this.v) {
            ...
            if (i2 > j33Var.a(0)) {
                ...
                int[] iArr = j33Var.a;
                int min = Math.min(iArr.length, j33Var.b);
                int i3 = 0;
                while (true) {
                    if (i3 < min) {
                        if (iArr[i3] == i2) {
    ...
    public final void w(int i) {
        ...
        if (i > 0) {
            ...
            if (i5 < i) {
                ...
                int i8 = max - i6;
                nu.d0(0, 0, i4 * 5, iArr, iArr2);
                nu.d0((i4 + i8) * 5, (i5 + i4) * 5, length * 5, iArr, iArr2);
                this.b = iArr2;
                i5 = i8;
            }
            int i9 = this.u;
