...
public final class d64 {
    ...
    public final boolean c(int i, int i2, int i3, int[] iArr, int[] iArr2) {
        ...
        iArr3[1] = 0;
        if (e instanceof e64) {
            ((e64) e).c(viewGroup, i, i2, iArr3, i3);
            viewGroup = viewGroup;
        } else if (i3 == 0) {
            try {
    ...
    public final boolean d(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        if (this.d && (e = e(i5)) != null) {
            if (i == 0 && i2 == 0 && i3 == 0 && i4 == 0) {
                ...
                if (e instanceof f64) {
                    ((f64) e).d(viewGroup, i, i2, i3, i4, i5, iArr3);
                } else {
                    iArr3[0] = iArr3[0] + i3;
                    iArr3[1] = iArr3[1] + i4;
                    if (e instanceof e64) {
                        ((e64) e).e(viewGroup, i, i2, i3, i4, i5);
                    } else if (i5 == 0) {
                        try {
        ...
        if (!f(i2)) {
            if (this.d) {
                ...
                for (ViewParent parent = view.getParent(); parent != null; parent = parent.getParent()) {
                    boolean z = parent instanceof e64;
                    if (z) {
                        onStartNestedScroll = ((e64) parent).f(view2, view, i, i2);
                    } else {
                        if (i2 == 0) {
                            try {
