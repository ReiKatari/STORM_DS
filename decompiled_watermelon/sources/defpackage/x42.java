...
public final class x42 implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        float f4 = fArr[min];
        return b31.a(fArr[min + 1], f4, f3, f4);
    }

    public x42(float[] fArr) {
        this.a = fArr;
