...
public final class y1 extends View.AccessibilityDelegate {
    ...
    public final void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        Object tag3;
        int i;
        t2 t2Var = new t2(accessibilityNodeInfo);
        WeakHashMap weakHashMap = aa7.a;
        ClickableSpan[] clickableSpanArr = null;
        if (Build.VERSION.SDK_INT >= 28) {
            tag = Boolean.valueOf(v97.c(view));
        } else {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            tag2 = Boolean.valueOf(v97.b(view));
        } else {
        ...
        if (i2 >= 30) {
            o2.l(accessibilityNodeInfo, charSequence);
        } else {
        ...
        if (i2 < 26) {
            ...
            if (clickableSpanArr != null && clickableSpanArr.length > 0) {
                ...
                for (int i5 = 0; i5 < clickableSpanArr.length; i5++) {
                    ...
                    t2Var.c("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_START_KEY").add(Integer.valueOf(spanned.getSpanStart(clickableSpan2)));
                    t2Var.c("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_END_KEY").add(Integer.valueOf(spanned.getSpanEnd(clickableSpan2)));
                    t2Var.c("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_FLAGS_KEY").add(Integer.valueOf(spanned.getSpanFlags(clickableSpan2)));
                    t2Var.c("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ID_KEY").add(Integer.valueOf(i));
                }
            }
        }
