...
public class dr extends RadioButton implements st6 {
    public final dq A;
    public final y9 B;
    public final zr L;
    public yq R;
    ...
    public dr(Context context, AttributeSet attributeSet) {
        ...
        this.A = dqVar;
        dqVar.d(attributeSet, R.attr.radioButtonStyle);
        y9 y9Var = new y9(this);
        this.B = y9Var;
        y9Var.k(attributeSet, R.attr.radioButtonStyle);
        zr zrVar = new zr(this);
        this.L = zrVar;
        zrVar.f(attributeSet, R.attr.radioButtonStyle);
