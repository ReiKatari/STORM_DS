...
public final class nq0 {
    ...
    public nq0(TextInputLayout textInputLayout) {
    ...
    public final void b() {
        ...
        x42 x42Var = jo.b;
        this.b0 = 1.0f - h(RecyclerView.A1, 1.0f, 1.0f - f, x42Var);
        textInputLayout.postInvalidateOnAnimation();
        this.c0 = h(1.0f, RecyclerView.A1, f, x42Var);
        textInputLayout.postInvalidateOnAnimation();
        ...
        float f3 = this.X;
        if (f2 != f3) {
            textPaint.setLetterSpacing(h(f3, f2, f, x42Var));
        } else {
            textPaint.setLetterSpacing(f2);
        }
        this.H = jo.a(RecyclerView.A1, this.S, f);
        this.I = jo.a(RecyclerView.A1, this.T, f);
        this.J = jo.a(RecyclerView.A1, this.U, f);
    ...
    public final boolean c(CharSequence charSequence) {
        ...
        if (this.E) {
            ...
            return i40Var.d(charSequence.length(), charSequence);
        }
        return z;
    }
    ...
    public final void d(float f, boolean z) {
        ...
        if (this.B != null) {
            ...
            if (Math.abs(f - 1.0f) < 1.0E-5f) {
                ...
                float f5 = this.X;
                typeface = this.v;
                if (Math.abs(f - RecyclerView.A1) < 1.0E-5f) {
                    this.F = 1.0f;
                } else {
            ...
            int i3 = (width2 > RecyclerView.A1 ? 1 : (width2 == RecyclerView.A1 ? 0 : -1));
            TextPaint textPaint = this.O;
            boolean z8 = false;
            if (i3 > 0) {
                if (this.G != f2) {
    ...
    public final StaticLayout e(int i, TextPaint textPaint, CharSequence charSequence, float f, boolean z) {
        ...
        xe6 xe6Var = new xe6(charSequence, textPaint, (int) f);
        xe6Var.l = this.A;
        xe6Var.k = z;
        xe6Var.e = alignment;
        xe6Var.j = false;
        xe6Var.f = i;
        xe6Var.g = RecyclerView.A1;
        xe6Var.h = this.g0;
        xe6Var.i = this.h0;
        xe6Var.m = null;
    ...
    public final void i(Configuration configuration) {
        if (Build.VERSION.SDK_INT >= 31) {
            ...
            if (typeface != null) {
                this.t = nk2.P(configuration, typeface);
            }
            Typeface typeface2 = this.x;
            if (typeface2 != null) {
                this.w = nk2.P(configuration, typeface2);
            }
    ...
    public final void j(boolean z) {
        ...
        if ((textInputLayout.getHeight() > 0 && textInputLayout.getWidth() > 0) || z) {
            ...
            if (this.a0 <= rect.width()) {
                float f4 = this.p;
                float max = Math.max((float) RecyclerView.A1, rect.left - f4) + f4;
                this.p = max;
                this.p = Math.min((float) RecyclerView.A1, rect.right - (this.a0 + max)) + max;
            }
            float f5 = this.i;
            ...
            if (textPaint2.descent() + (-textPaint2.ascent()) <= rect.height()) {
                float f6 = this.n;
                float max2 = Math.max((float) RecyclerView.A1, rect.top - f6) + f6;
                this.n = max2;
                this.n = Math.min((float) RecyclerView.A1, rect.bottom - (f() + max2)) + max2;
            }
            d(RecyclerView.A1, z);
    ...
    public final boolean l(Typeface typeface) {
        ...
        if (this.u != typeface) {
            this.u = typeface;
            Typeface P = nk2.P(this.a.getContext().getResources().getConfiguration(), typeface);
            this.t = P;
            if (P == null) {
                P = this.u;
            }
    ...
    */
    public final void m(float r3) {
        ...
        L19:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.nq0.m(float):void");
    }
