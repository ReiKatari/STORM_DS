...
public final class d27 implements Collection, f93 {
    ...
    */
    public final boolean containsAll(java.util.Collection r7) {
        ...
        L39:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.d27.containsAll(java.util.Collection):boolean");
    }

    @Override // java.util.Collection
    public final boolean equals(Object obj) {
        if (obj instanceof d27) {
            if (!this.A.equals(((d27) obj).A)) {
                return false;
            }
            return true;
        }
