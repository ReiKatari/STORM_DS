...
public abstract class vb7 {
    ...
    public final float b(float f, long j, u93 u93Var, View view) {
        this.a.E(f, this.g);
        float[] fArr = this.g;
        boolean z = true;
        float f2 = fArr[1];
    ...
    public abstract boolean d(float f, long j, u93 u93Var, View view);
    ...
    public final String toString() {
        ...
        for (int i = 0; i < this.e; i++) {
            ...
            t.append(this.c[i]);
            t.append(" , ");
            t.append(decimalFormat.format(this.d[i]));
            t.append("] ");
            str = t.toString();
        }
        return str;
