...
public final class t2 {
    ...
    public t2(AccessibilityNodeInfo accessibilityNodeInfo) {
    ...
    public final void b(n2 n2Var) {
        this.a.addAction((AccessibilityNodeInfo.AccessibilityAction) n2Var.a);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.c == t2Var.c && this.b == t2Var.b) {
            return true;
        }
        return false;
    }
    ...
    public final CharSequence g() {
        ...
        if (!isEmpty) {
            ...
            for (int i = 0; i < c.size(); i++) {
                spannableString.setSpan(new x1(((Integer) c4.get(i)).intValue(), this, accessibilityNodeInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer) c.get(i)).intValue(), ((Integer) c2.get(i)).intValue(), ((Integer) c3.get(i)).intValue());
            }
    ...
    public final void j(dk7 dk7Var) {
        this.a.setCollectionInfo(null);
    }

    public final void k(s2 s2Var) {
        this.a.setCollectionItemInfo((AccessibilityNodeInfo.CollectionItemInfo) s2Var.b);
    }
    ...
    public final String toString() {
        ...
        if (i3 >= 34) {
            a2.d(accessibilityNodeInfo, rect);
        } else {
        ...
        if (i3 >= 30) {
            charSequence = o2.f(accessibilityNodeInfo);
        } else {
        ...
        if (i3 >= 36) {
            charSequence2 = q2.c(accessibilityNodeInfo);
        } else {
        ...
        sb.append("; uniqueId: ");
        if (i3 >= 33) {
            string = p2.g(accessibilityNodeInfo);
        } else {
        ...
        if (i3 >= 34) {
            charSequence4 = a2.e(accessibilityNodeInfo);
        } else {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            arrayList.add(new n2(actionList.get(i4), 0, null, null, null));
        }
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            n2 n2Var = (n2) arrayList.get(i5);
            int a = n2Var.a();
            Object obj = n2Var.a;
            String d2 = d(a);
