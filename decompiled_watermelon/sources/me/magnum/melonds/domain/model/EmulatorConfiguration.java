...
public final class EmulatorConfiguration {
    ...
    public static /* synthetic */ EmulatorConfiguration copy$default(EmulatorConfiguration emulatorConfiguration, boolean z, boolean z2, Uri uri, Uri uri2, Uri uri3, Uri uri4, Uri uri5, Uri uri6, Uri uri7, String str, float f, float f2, boolean z3, int i, int i2, boolean z4, boolean z5, ConsoleType consoleType, boolean z6, AudioInterpolation audioInterpolation, AudioBitrate audioBitrate, int i3, AudioLatency audioLatency, MicSource micSource, FirmwareConfiguration firmwareConfiguration, RendererConfiguration rendererConfiguration, DldiSdCardConfiguration dldiSdCardConfiguration, long j, int i4, Object obj) {
        ...
        AudioLatency audioLatency2 = (i4 & 4194304) != 0 ? emulatorConfiguration.audioLatency : audioLatency;
        MicSource micSource2 = (i4 & 8388608) != 0 ? emulatorConfiguration.micSource : micSource;
        FirmwareConfiguration firmwareConfiguration2 = (i4 & 16777216) != 0 ? emulatorConfiguration.firmwareConfiguration : firmwareConfiguration;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.useCustomBios == emulatorConfiguration.useCustomBios && this.showBootScreen == emulatorConfiguration.showBootScreen && b53.x(this.dsBios7Uri, emulatorConfiguration.dsBios7Uri) && b53.x(this.dsBios9Uri, emulatorConfiguration.dsBios9Uri) && b53.x(this.dsFirmwareUri, emulatorConfiguration.dsFirmwareUri) && b53.x(this.dsiBios7Uri, emulatorConfiguration.dsiBios7Uri) && b53.x(this.dsiBios9Uri, emulatorConfiguration.dsiBios9Uri) && b53.x(this.dsiFirmwareUri, emulatorConfiguration.dsiFirmwareUri) && b53.x(this.dsiNandUri, emulatorConfiguration.dsiNandUri) && b53.x(this.internalDirectory, emulatorConfiguration.internalDirectory) && Float.compare(this.fastForwardSpeedMultiplier, emulatorConfiguration.fastForwardSpeedMultiplier) == 0 && Float.compare(this.frameLimitSpeedMultiplier, emulatorConfiguration.frameLimitSpeedMultiplier) == 0 && this.rewindEnabled == emulatorConfiguration.rewindEnabled && this.rewindPeriodSeconds == emulatorConfiguration.rewindPeriodSeconds && this.rewindWindowSeconds == emulatorConfiguration.rewindWindowSeconds && this.useJit == emulatorConfiguration.useJit && this.hgEngineFixEnabled == emulatorConfiguration.hgEngineFixEnabled && this.consoleType == emulatorConfiguration.consoleType && this.soundEnabled == emulatorConfiguration.soundEnabled && this.audioInterpolation == emulatorConfiguration.audioInterpolation && this.audioBitrate == emulatorConfiguration.audioBitrate && this.volume == emulatorConfiguration.volume && this.audioLatency == emulatorConfiguration.audioLatency && this.micSource == emulatorConfiguration.micSource && b53.x(this.firmwareConfiguration, emulatorConfiguration.firmwareConfiguration) && b53.x(this.rendererConfiguration, emulatorConfiguration.rendererConfiguration) && b53.x(this.dldiSdCardConfiguration, emulatorConfiguration.dldiSdCardConfiguration) && this.dsiWareAutoloadTitleId == emulatorConfiguration.dsiWareAutoloadTitleId) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode5;
        int hashCode6;
        int c = ej6.c(Boolean.hashCode(this.useCustomBios) * 31, this.showBootScreen, 31);
        ...
        int c2 = ej6.c((this.consoleType.hashCode() + ej6.c(ej6.c(wh1.a(this.rewindWindowSeconds, wh1.a(this.rewindPeriodSeconds, ej6.c(ej6.a(this.frameLimitSpeedMultiplier, ej6.a(this.fastForwardSpeedMultiplier, ej6.b((i7 + i) * 31, 31, this.internalDirectory), 31), 31), this.rewindEnabled, 31), 31), 31), this.useJit, 31), this.hgEngineFixEnabled, 31)) * 31, this.soundEnabled, 31);
        int a = wh1.a(this.volume, (this.audioBitrate.hashCode() + ((this.audioInterpolation.hashCode() + c2) * 31)) * 31, 31);
    ...
    public /* synthetic */ EmulatorConfiguration(boolean z, boolean z2, Uri uri, Uri uri2, Uri uri3, Uri uri4, Uri uri5, Uri uri6, Uri uri7, String str, float f, float f2, boolean z3, int i, int i2, boolean z4, boolean z5, ConsoleType consoleType, boolean z6, AudioInterpolation audioInterpolation, AudioBitrate audioBitrate, int i3, AudioLatency audioLatency, MicSource micSource, FirmwareConfiguration firmwareConfiguration, RendererConfiguration rendererConfiguration, DldiSdCardConfiguration dldiSdCardConfiguration, long j, int i4, n91 n91Var) {
