...
public final class DldiSdCardConfiguration {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.enabled == dldiSdCardConfiguration.enabled && b53.x(this.imagePath, dldiSdCardConfiguration.imagePath) && this.imageSize == dldiSdCardConfiguration.imageSize && this.folderSync == dldiSdCardConfiguration.folderSync && b53.x(this.folderPath, dldiSdCardConfiguration.folderPath)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int c = ej6.c(wh1.a(this.imageSize, (hashCode2 + hashCode) * 31, 31), this.folderSync, 31);
