...
public final class Cheat {
    ...
    public boolean equals(Object obj) {
        ...
        if (b53.x(this.id, cheat.id) && this.cheatDatabaseId == cheat.cheatDatabaseId && b53.x(this.name, cheat.name) && b53.x(this.description, cheat.description) && b53.x(this.code, cheat.code) && this.enabled == cheat.enabled) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int b = ej6.b(b31.c(this.cheatDatabaseId, hashCode * 31, 31), 31, this.name);
        String str = this.description;
        if (str != null) {
            i = str.hashCode();
        }
        return Boolean.hashCode(this.enabled) + ej6.b((b + i) * 31, 31, this.code);
    }
    ...
    public String toString() {
        ...
        sb.append(j);
        b31.B(sb, ", name=", str, ", description=", str2);
        sb.append(", code=");
        sb.append(str3);
        sb.append(", enabled=");
        sb.append(z);
