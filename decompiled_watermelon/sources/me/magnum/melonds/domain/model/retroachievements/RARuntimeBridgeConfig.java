...
public final class RARuntimeBridgeConfig {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.runtimeMode == rARuntimeBridgeConfig.runtimeMode && b53.x(this.userAgent, rARuntimeBridgeConfig.userAgent) && b53.x(this.username, rARuntimeBridgeConfig.username) && b53.x(this.apiToken, rARuntimeBridgeConfig.apiToken) && b53.x(this.gameHash, rARuntimeBridgeConfig.gameHash) && b53.x(this.gameId, rARuntimeBridgeConfig.gameId) && this.submissionSessionId == rARuntimeBridgeConfig.submissionSessionId && this.hardcoreEnabled == rARuntimeBridgeConfig.hardcoreEnabled && this.unofficialEnabled == rARuntimeBridgeConfig.unofficialEnabled && this.encoreEnabled == rARuntimeBridgeConfig.encoreEnabled && b53.x(this.apiHost, rARuntimeBridgeConfig.apiHost) && this.usesProxyHost == rARuntimeBridgeConfig.usesProxyHost && this.endpointGeneration == rARuntimeBridgeConfig.endpointGeneration) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return Long.hashCode(this.endpointGeneration) + ej6.c(ej6.b(ej6.c(ej6.c(ej6.c(b31.c(this.submissionSessionId, (i5 + i) * 31, 31), this.hardcoreEnabled, 31), this.unofficialEnabled, 31), this.encoreEnabled, 31), 31, this.apiHost), this.usesProxyHost, 31);
    }
    ...
    public String toString() {
        ...
        sb.append(str);
        sb.append(", username=");
        b31.B(sb, str2, ", apiToken=", str3, ", gameHash=");
        sb.append(str4);
        sb.append(", gameId=");
        sb.append(l);
        ...
        sb.append(z4);
        return wh1.p(sb, ", endpointGeneration=", j2, ")");
    }
}
