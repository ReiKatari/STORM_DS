...
public abstract class Hilt_RomsPreferencesFragment extends BasePreferenceFragment implements el2 {
    public ba7 B;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.Y) {
            this.Y = true;
            ((RomsPreferencesFragment_GeneratedInjector) d()).i((RomsPreferencesFragment) this);
        }
    }
