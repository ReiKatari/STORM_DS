...
public abstract class Hilt_RetroAchievementsPreferencesFragment extends BasePreferenceFragment implements el2 {
    public ba7 B;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.Y) {
            this.Y = true;
            ((RetroAchievementsPreferencesFragment_GeneratedInjector) d()).g((RetroAchievementsPreferencesFragment) this);
        }
    }
