...
public final class i94 implements defpackage.b31, androidx.window.reflection.Consumer2 {
    ...
    public i94(android.content.Context r1) {
            r0 = this;
            r0.<init>()
            r0.a = r1
    ...
    public final void accept(java.lang.Object r3) {
            r2 = this;
            androidx.window.extensions.layout.WindowLayoutInfo r3 = (androidx.window.extensions.layout.WindowLayoutInfo) r3
            r3.getClass()
            java.util.concurrent.locks.ReentrantLock r0 = r2.b
            r0.lock()
            android.content.Context r1 = r2.a     // Catch: java.lang.Throwable -> L28
            kv7 r3 = defpackage.t82.c(r1, r3)     // Catch: java.lang.Throwable -> L28
            r2.c = r3     // Catch: java.lang.Throwable -> L28
            java.util.LinkedHashSet r2 = r2.d     // Catch: java.lang.Throwable -> L28
            java.util.Iterator r2 = r2.iterator()     // Catch: java.lang.Throwable -> L28
        L18:
            boolean r1 = r2.hasNext()     // Catch: java.lang.Throwable -> L28
            if (r1 == 0) goto L2a
            java.lang.Object r1 = r2.next()     // Catch: java.lang.Throwable -> L28
            b31 r1 = (defpackage.b31) r1     // Catch: java.lang.Throwable -> L28
            r1.accept(r3)     // Catch: java.lang.Throwable -> L28
            goto L18
        L28:
            r2 = move-exception
            goto L2e
