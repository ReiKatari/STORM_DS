...
public abstract class hz7 extends android.os.Binder implements android.os.IInterface {
    public hz7(java.lang.String r1) {
            r0 = this;
            r0.<init>()
    ...
    public final boolean onTransact(int r2, android.os.Parcel r3, android.os.Parcel r4, int r5) {
        ...
        L14:
            boolean r1 = r1.zaa(r2, r3, r4, r5)
            return r1
    }

    public abstract boolean zaa(int r1, android.os.Parcel r2, android.os.Parcel r3, int r4);
}
