...
public abstract class kz7 {
    static {
            java.lang.Class<kz7> r0 = defpackage.kz7.class
            r0.getClassLoader()
            return
    }
    ...
    public static void c(android.os.Parcel r2, com.google.android.gms.common.internal.safeparcel.AbstractSafeParcelable r3) {
            r0 = 0
            if (r3 != 0) goto L7
            r2.writeInt(r0)
            return
