...
public class FloatingActionButton$BaseBehavior<T> extends defpackage.e51 {
    ...
    public FloatingActionButton$BaseBehavior(android.content.Context r1, android.util.AttributeSet r2) {
            r0 = this;
            r0.<init>()
    ...
    public final boolean e(android.view.View r1) {
            r0 = this;
