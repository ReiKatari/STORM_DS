...
public abstract class b {
    ...
    public static final void a(c cVar, g0 g0Var) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (i0Var instanceof k0) {
                h hVar = new h();
                k0 k0Var = (k0) i0Var;
                hVar.f10746d = k0Var.B;
                hVar.f10755n = true;
                hVar.c();
                int i10 = k0Var.L;
                Path path = hVar.f10760s.f6635a;
                if (i10 == 1) {
                ...
                hVar.c();
                hVar.c();
                hVar.f10744b = k0Var.R;
                hVar.c();
                hVar.f10745c = k0Var.X;
                hVar.c();
                hVar.f10749g = k0Var.Y;
                hVar.c();
                hVar.f10747e = k0Var.Z;
                hVar.c();
                hVar.f10748f = k0Var.f10781b0;
                hVar.f10756o = true;
                hVar.c();
                hVar.f10750h = k0Var.f10782c0;
                hVar.f10756o = true;
                hVar.c();
                hVar.f10751i = k0Var.f10783d0;
                hVar.f10756o = true;
                hVar.c();
                hVar.f10752j = k0Var.f10784e0;
                hVar.f10756o = true;
                hVar.c();
                hVar.f10753k = k0Var.f10785f0;
                hVar.f10757p = true;
                hVar.c();
                hVar.f10754l = k0Var.f10786g0;
                hVar.f10757p = true;
                hVar.c();
                hVar.m = k0Var.f10787h0;
                hVar.f10757p = true;
                hVar.c();
                cVar.e(i2, hVar);
                ...
                c cVar2 = new c();
                g0 g0Var2 = (g0) i0Var;
                cVar2.f10688k = g0Var2.A;
                cVar2.c();
                cVar2.f10689l = g0Var2.B;
                cVar2.f10695s = true;
                cVar2.c();
                cVar2.f10691o = g0Var2.X;
                cVar2.f10695s = true;
                cVar2.c();
                cVar2.f10692p = g0Var2.Y;
                cVar2.f10695s = true;
                cVar2.c();
                cVar2.f10693q = g0Var2.Z;
                cVar2.f10695s = true;
                cVar2.c();
                cVar2.f10694r = g0Var2.f10741b0;
                cVar2.f10695s = true;
                cVar2.c();
                cVar2.m = g0Var2.L;
                cVar2.f10695s = true;
                cVar2.c();
                cVar2.f10690n = g0Var2.R;
                cVar2.f10695s = true;
                cVar2.c();
                cVar2.f10683f = g0Var2.f10742c0;
                cVar2.f10684g = true;
                cVar2.c();
                a(cVar2, g0Var2);
                cVar.e(i2, cVar2);
    ...
    public static final void b(i3.h hVar, double d4, double d10, double d11, double d12, double d13, double d14, double d15, boolean z10, boolean z11) {
        double d16;
        double d17;
        boolean z12;
        double d18 = d13;
        ...
        if (d29 != 0.0d) {
            ...
            if (d30 < 0.0d) {
                ...
                b(hVar, d4, d10, d11, d12, d18 * sqrt, d14 * sqrt, d15, z10, z11);
                return;
            }
            ...
            while (i10 < ceil) {
                ...
                double d58 = d37;
                hVar.f6635a.cubicTo((float) ((d48 * sqrt3) + d49), (float) ((d50 * sqrt3) + d51), (float) (d53 - (sqrt3 * d55)), (float) (d54 - (sqrt3 * d56)), (float) d53, (float) d54);
                sin2 = sin2;
                d49 = d53;
                i10 = i11 + 1;
                d35 = d35;
    ...
    */
    public static final long c(int r32, int r33, java.lang.String r34) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: o3.b.c(int, int, java.lang.String):long");
    }

    public static final j0 d(f fVar, n2.m mVar) {
        x4.c cVar;
        i3.l lVar;
        n2.r rVar = (n2.r) mVar;
        float b10 = ((x4.c) rVar.j(q1.f1919h)).b();
        boolean e6 = rVar.e((Float.floatToRawIntBits(b10) & 4294967295L) | (Float.floatToRawIntBits(fVar.f10740j) << 32));
        Object L = rVar.L();
        if (e6 || L == n2.l.f9953a) {
            c cVar2 = new c();
            a(cVar2, fVar.f10736f);
            float f8 = fVar.f10732b;
            float f10 = fVar.f10733c;
            long floatToRawIntBits = (Float.floatToRawIntBits(cVar.v(f8)) << 32) | (Float.floatToRawIntBits(cVar.v(f10)) & 4294967295L);
            float f11 = fVar.f10734d;
            float f12 = fVar.f10735e;
            if (Float.isNaN(f11)) {
            ...
            String str = fVar.f10731a;
            long j2 = fVar.f10737g;
            int i2 = fVar.f10738h;
            if (j2 != 16) {
                lVar = new i3.l(i2, j2);
            } else {
            ...
            boolean z10 = fVar.f10739i;
            j0Var.X.setValue(new h3.e(floatToRawIntBits));
            j0Var.Y.setValue(Boolean.valueOf(z10));
            e0 e0Var = j0Var.Z;
            e0Var.f10723g.setValue(lVar);
            e0Var.f10725i.setValue(new h3.e(floatToRawIntBits2));
            e0Var.f10719c = str;
            rVar.h0(j0Var);
            L = j0Var;
        }
    ...
    public static final void e(List list, i3.h hVar) {
        boolean z10;
        b0 b0Var;
        Path path;
        int i2;
        ...
        float f17;
        List list2 = list;
        Path path2 = hVar.f6635a;
        Path path3 = hVar.f6635a;
        ...
        while (i11 < size) {
            ...
            if (b0Var3 instanceof j) {
                ...
                if (b0Var3 instanceof v) {
                    v vVar = (v) b0Var3;
                    float f25 = vVar.f10819c;
                    f21 += f25;
                    float f26 = vVar.f10820d;
                    f22 += f26;
                    ...
                    if (b0Var3 instanceof n) {
                        n nVar = (n) b0Var3;
                        float f27 = nVar.f10791c;
                        float f28 = nVar.f10792d;
                        ...
                        if (b0Var3 instanceof u) {
                            u uVar = (u) b0Var3;
                            float f29 = uVar.f10818d;
                            float f30 = uVar.f10817c;
                            path3.rLineTo(f30, f29);
                            f21 += f30;
                            f22 += f29;
                        } else if (b0Var3 instanceof m) {
                            m mVar = (m) b0Var3;
                            float f31 = mVar.f10790d;
                            float f32 = mVar.f10789c;
                            path3.lineTo(f32, f31);
                            f21 = f32;
                            path = path3;
                            f22 = f31;
                        } else if (b0Var3 instanceof t) {
                            float f33 = ((t) b0Var3).f10816c;
                            path3.rLineTo(f33, f18);
                            f21 += f33;
                        } else if (b0Var3 instanceof l) {
                            float f34 = ((l) b0Var3).f10788c;
                            path3.lineTo(f34, f22);
                            f21 = f34;
                        } else {
                            if (b0Var3 instanceof z) {
                                f17 = ((z) b0Var3).f10831c;
                                path3.rLineTo(f18, f17);
                            } else if (b0Var3 instanceof a0) {
                                float f35 = ((a0) b0Var3).f10674c;
                                path3.lineTo(f21, f35);
                                f22 = f35;
                            } else if (b0Var3 instanceof s) {
                                s sVar = (s) b0Var3;
                                path3.rCubicTo(sVar.f10810c, sVar.f10811d, sVar.f10812e, sVar.f10813f, sVar.f10814g, sVar.f10815h);
                                f19 = sVar.f10812e + f21;
                                f20 = sVar.f10813f + f22;
                                f21 += sVar.f10814g;
                                f17 = sVar.f10815h;
                            } else {
                                if (b0Var3 instanceof k) {
                                    k kVar = (k) b0Var3;
                                    path3.cubicTo(kVar.f10775c, kVar.f10776d, kVar.f10777e, kVar.f10778f, kVar.f10779g, kVar.f10780h);
                                    f19 = kVar.f10777e;
                                    f20 = kVar.f10778f;
                                    f13 = kVar.f10779g;
                                    f14 = kVar.f10780h;
                                    ...
                                    x xVar = (x) b0Var3;
                                    path3.rCubicTo(f15, f16, xVar.f10825c, xVar.f10826d, xVar.f10827e, xVar.f10828f);
                                    f19 = xVar.f10825c + f21;
                                    f20 = xVar.f10826d + f22;
                                    f21 += xVar.f10827e;
                                    f17 = xVar.f10828f;
                                    ...
                                    p pVar = (p) b0Var3;
                                    path3.cubicTo(f21, f22, pVar.f10797c, pVar.f10798d, pVar.f10799e, pVar.f10800f);
                                    f19 = pVar.f10797c;
                                    f20 = pVar.f10798d;
                                    f13 = pVar.f10799e;
                                    f14 = pVar.f10800f;
                                    ...
                                    w wVar = (w) b0Var3;
                                    float f37 = wVar.f10824f;
                                    float f38 = wVar.f10823e;
                                    float f39 = wVar.f10822d;
                                    float f40 = wVar.f10821c;
                                    ...
                                    if (b0Var3 instanceof o) {
                                        o oVar = (o) b0Var3;
                                        float f43 = oVar.f10796f;
                                        float f44 = oVar.f10795e;
                                        float f45 = oVar.f10794d;
                                        f12 = oVar.f10793c;
                                        ...
                                        y yVar = (y) b0Var3;
                                        float f46 = yVar.f10830d;
                                        float f47 = yVar.f10829c;
                                        ...
                                        q qVar = (q) b0Var3;
                                        float f50 = qVar.f10802d;
                                        float f51 = qVar.f10801c;
                                        ...
                                        r rVar = (r) b0Var3;
                                        float f52 = rVar.f10808h + f21;
                                        float f53 = rVar.f10809i + f22;
                                        i2 = size;
                                        f8 = 0.0f;
                                        path = path3;
                                        i10 = i11;
                                        b(hVar, f21, f22, f52, f53, rVar.f10803c, rVar.f10804d, rVar.f10805e, rVar.f10806f, rVar.f10807g);
                                        f19 = f52;
                                        f21 = f19;
                                        f20 = f53;
                                        f22 = f20;
                                        ...
                                        if (b0Var3 instanceof i) {
                                            i iVar = (i) b0Var3;
                                            float f54 = iVar.f10770i;
                                            float f55 = iVar.f10769h;
                                            b0Var2 = b0Var3;
                                            b(hVar, f21, f22, f55, f54, iVar.f10764c, iVar.f10765d, iVar.f10766e, iVar.f10767f, iVar.f10768g);
                                            f20 = f54;
                                            f22 = f20;
                                            f19 = f55;
                                            f21 = f19;
