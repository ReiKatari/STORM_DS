...
public abstract class Hilt_SaveFilesPreferencesFragment extends BasePreferenceFragment implements mb.c {
    public kb.i A;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.X) {
            this.X = true;
            ((SaveFilesPreferencesFragment_GeneratedInjector) d()).b((SaveFilesPreferencesFragment) this);
        }
    }
