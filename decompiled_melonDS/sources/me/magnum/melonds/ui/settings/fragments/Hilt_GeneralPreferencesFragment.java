...
public abstract class Hilt_GeneralPreferencesFragment extends BasePreferenceFragment implements mb.c {
    public kb.i A;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.X) {
            this.X = true;
            ((GeneralPreferencesFragment_GeneratedInjector) d()).f((GeneralPreferencesFragment) this);
        }
    }
