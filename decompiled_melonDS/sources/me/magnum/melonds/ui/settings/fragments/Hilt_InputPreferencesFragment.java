...
public abstract class Hilt_InputPreferencesFragment extends BasePreferenceFragment implements mb.c {
    public kb.i A;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.X) {
            this.X = true;
            ((InputPreferencesFragment_GeneratedInjector) d()).d((InputPreferencesFragment) this);
        }
    }
