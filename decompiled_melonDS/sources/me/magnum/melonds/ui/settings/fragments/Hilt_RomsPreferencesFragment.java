...
public abstract class Hilt_RomsPreferencesFragment extends BasePreferenceFragment implements mb.c {
    public kb.i A;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.X) {
            this.X = true;
            ((RomsPreferencesFragment_GeneratedInjector) d()).h((RomsPreferencesFragment) this);
        }
    }
