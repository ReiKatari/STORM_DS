...
public abstract class Hilt_VideoPreferencesFragment extends BasePreferenceFragment implements mb.c {
    public kb.i A;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.X) {
            this.X = true;
            ((VideoPreferencesFragment_GeneratedInjector) d()).g((VideoPreferencesFragment) this);
        }
    }
