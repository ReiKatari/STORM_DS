...
public abstract class Hilt_CheatsPreferencesFragment extends BasePreferenceFragment implements mb.c {
    public kb.i A;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.X) {
            this.X = true;
            CheatsPreferencesFragment cheatsPreferencesFragment = (CheatsPreferencesFragment) this;
            ((CheatsPreferencesFragment_GeneratedInjector) d()).getClass();
        }
    }
