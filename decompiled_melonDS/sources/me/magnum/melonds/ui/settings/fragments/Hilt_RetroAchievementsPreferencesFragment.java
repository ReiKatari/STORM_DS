...
public abstract class Hilt_RetroAchievementsPreferencesFragment extends BasePreferenceFragment implements mb.c {
    public kb.i A;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.X) {
            this.X = true;
            RetroAchievementsPreferencesFragment retroAchievementsPreferencesFragment = (RetroAchievementsPreferencesFragment) this;
            ((RetroAchievementsPreferencesFragment_GeneratedInjector) d()).getClass();
        }
    }
