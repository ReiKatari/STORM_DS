...
public abstract class Hilt_SystemPreferencesFragment extends BasePreferenceFragment implements mb.c {
    public kb.i A;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.X) {
            this.X = true;
            ((SystemPreferencesFragment_GeneratedInjector) d()).a((SystemPreferencesFragment) this);
        }
    }
