...
public abstract class Hilt_FirmwarePreferencesFragment extends BasePreferenceFragment implements mb.c {
    public kb.i A;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.X) {
            this.X = true;
            ((FirmwarePreferencesFragment_GeneratedInjector) d()).c((FirmwarePreferencesFragment) this);
        }
    }
