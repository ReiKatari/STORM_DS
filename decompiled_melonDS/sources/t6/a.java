...
public final class a implements Interpolator {
    ...
    public final float getInterpolation(float f8) {
        ...
        float[] fArr = this.f13133a;
        int min = Math.min((int) ((fArr.length - 1) * f8), fArr.length - 2);
        float f10 = this.f13134b;
        float f11 = fArr[min];
        return d.a(fArr[min + 1], f11, (f8 - (min * f10)) / f10, f11);
    }

    public a(float[] fArr) {
        this.f13133a = fArr;
        this.f13134b = 1.0f / (fArr.length - 1);
    }
}
