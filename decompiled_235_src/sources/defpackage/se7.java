...
public final class se7 extends ReplacementSpan {
    public final re7 B;
    public TextPaint X;
    ...
    public se7(re7 re7Var) {
        np2.x(re7Var, "rasterizer cannot be null");
        this.B = re7Var;
    }
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        paint2.setTypeface((Typeface) ebVar.X);
        canvas.drawText((char[]) ebVar.L, re7Var.a * 2, 2, f, f2, paint2);
