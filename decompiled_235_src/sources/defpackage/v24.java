...
public final class v24 {
    ...
    public static float[] a() {
        return new float[]{1.0f, RecyclerView.B1, RecyclerView.B1, RecyclerView.B1, RecyclerView.B1, 1.0f, RecyclerView.B1, RecyclerView.B1, RecyclerView.B1, RecyclerView.B1, 1.0f, RecyclerView.B1, RecyclerView.B1, RecyclerView.B1, RecyclerView.B1, 1.0f};
    }
    ...
    public static final void c(float[] fArr, ia4 ia4Var) {
        if (fArr.length < 16) {
            return;
        }
        float f = fArr[0];
        ...
        ia4Var.a = Math.min(f20, Math.min(f27, Math.min(f33, f37)));
        ia4Var.b = Math.min(f23, Math.min(f29, Math.min(f35, f38)));
        ia4Var.c = Math.max(f20, Math.max(f27, Math.max(f33, f37)));
        ia4Var.d = Math.max(f23, Math.max(f29, Math.max(f35, f38)));
    }
    ...
    public static final void f(float[] fArr, float f, float f2) {
        ...
        float f3 = (fArr[8] * RecyclerView.B1) + (fArr[4] * f2) + (fArr[0] * f) + fArr[12];
        float f4 = (fArr[9] * RecyclerView.B1) + (fArr[5] * f2) + (fArr[1] * f) + fArr[13];
        float f5 = (fArr[10] * RecyclerView.B1) + (fArr[6] * f2) + (fArr[2] * f) + fArr[14];
        float f6 = fArr[3] * f;
        float f7 = fArr[11] * RecyclerView.B1;
        fArr[12] = f3;
        fArr[13] = f4;
        fArr[14] = f5;
