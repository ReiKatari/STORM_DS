...
public final class t08 extends zbuf implements zbvn {
    private static final t08 zbb;
    private int zbd;
    private zbee zbe;
    private zbek zbf;
    private zbeh zbg;

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_vision_text_bundled_common.zbuf, t08] */
    static {
        ?? zbufVar = new zbuf();
        zbb = zbufVar;
        zbuf.zbD(t08.class, zbufVar);
    }
