...
public final class aj implements ja3 {
    ...
    public aj(Bitmap bitmap, in6 in6Var, qw4 qw4Var, int i) {
        boolean z;
        this.A = 4;
        if (bitmap != null) {
            z = true;
    ...
    public String c() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (obj instanceof wb6) {
                wb6 wb6Var = (wb6) obj;
                boolean k = nb3.k(wb6Var.e(), bt6.f);
                int[] iArr = (int[]) this.X;
                if (k) {
                    if (iArr[i2] != -1) {
                        sb.append("[");
    ...
    public void d(char c) {
        ...
        if (c < 128) {
            ...
            throw new le3(lb1.k("Unexpected code point: ", c, ". Check your strings for malformed UTF-8 sequences."), 6, null);
        }
    }
    ...
    public void u(char[] cArr, int i) {
        ...
        if (i >= 0) {
            ...
            StringBuilder t = xg6.t("count > string.length: ", i, " > ");
    ...
    public aj(Bundle bundle) {
        this.A = 3;
        bundle.getClass();
        this.L = uj2.P(bundle, "nav-entry-state:id");
        this.B = uj2.I(bundle, "nav-entry-state:destination-id");
        this.R = uj2.N(bundle, "nav-entry-state:args");
        this.X = uj2.N(bundle, "nav-entry-state:saved-state");
    }
    ...
    public aj(in6 in6Var, qw4 qw4Var) {
        this((Bitmap) null, in6Var, qw4Var, 0);
        this.A = 4;
        StringBuilder sb = ck7.a;
        if (in6Var != null) {
        } else {
    ...
    public aj(int i, m80 m80Var, l61 l61Var, le2 le2Var) {
        this.A = 5;
        this.L = le2Var;
        this.B = i;
        this.R = m80Var;
