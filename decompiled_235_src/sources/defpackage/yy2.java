...
public abstract class yy2 {
    ...
    static {
        ...
        try {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(yy2.class.getResourceAsStream("/org/commonmark/internal/util/entities.properties"), Charset.forName("UTF-8")));
            while (true) {
