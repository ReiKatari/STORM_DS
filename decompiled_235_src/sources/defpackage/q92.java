...
public final class q92 implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        float f4 = fArr[min];
        return i61.a(fArr[min + 1], f4, f3, f4);
    }

    public q92(float[] fArr) {
        this.a = fArr;
