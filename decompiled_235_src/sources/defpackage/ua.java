...
public final class ua extends pr2 {
    ...
    static {
        ...
        pr2.l(ua.class, uaVar);
    }

    public static void m(ua uaVar) {
        uaVar.version_ = 0;
    }

    public static void n(ua uaVar, db dbVar) {
        uaVar.getClass();
        dbVar.getClass();
        uaVar.params_ = dbVar;
    }

    public static void o(ua uaVar, ca0 ca0Var) {
        uaVar.getClass();
        uaVar.keyValue_ = ca0Var;
    }

    public static ta s() {
        return (ta) DEFAULT_INSTANCE.e();
    }

    public static ua t(ea0 ea0Var, g82 g82Var) {
        return (ua) pr2.j(DEFAULT_INSTANCE, ea0Var, g82Var);
    }
