...
public final class tj7 {
    ...
    public static final go3[] b = {kj2.M(xr3.PUBLICATION, new kt5(18))};
    public final List a;
    ...
    public static final /* synthetic */ class a implements qr2 {
        ...
        /* JADX WARN: Type inference failed for: r0v0, types: [qr2, java.lang.Object, tj7$a] */
        static {
            ?? obj = new Object();
            a = obj;
            ly4 ly4Var = new ly4("me.magnum.rcheevosapi.dto.UserUnlocksDto", obj, 1);
            ly4Var.l("UserUnlocks", false);
            descriptor = ly4Var;
        }
        ...
        public final gg3[] b() {
            return new gg3[]{tj7.b[0].getValue()};
        }
        ...
        public final void d(x32 x32Var, Object obj) {
            ...
            c.w(wb6Var, 0, (gg3) tj7.b[0].getValue(), tj7Var.a);
            c.a(wb6Var);
        }
    ...
    public /* synthetic */ tj7(int i, List list) {
        if (1 == (i & 1)) {
            this.a = list;
        } else {
            ii2.S(i, 1, a.a.e());
    ...
    public final boolean equals(Object obj) {
        ...
        if ((obj instanceof tj7) && nb3.k(this.a, ((tj7) obj).a)) {
            return true;
        }
        return false;
    }
