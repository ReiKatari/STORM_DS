...
public final class vb0 {
    ...
    public vb0(float f, float f2, float f3, float f4, float f5, float f6) {
        this.a = f;
        this.b = f2;
        this.c = f3;
        this.d = f4;
    ...
    public static vb0 a(int i) {
        ...
        float pow;
        iq7 iq7Var = iq7.k;
        float W = nc1.W(Color.red(i));
        float W2 = nc1.W(Color.green(i));
        float W3 = nc1.W(Color.blue(i));
        float[][] fArr = nc1.d;
        float[] fArr2 = fArr[0];
        float f2 = (fArr2[2] * W3) + (fArr2[1] * W2) + (fArr2[0] * W);
        float[] fArr3 = fArr[1];
        float f3 = (fArr3[2] * W3) + (fArr3[1] * W2) + (fArr3[0] * W);
        float[] fArr4 = fArr[2];
        float f4 = (W3 * fArr4[2]) + (W2 * fArr4[1]) + (W * fArr4[0]);
        float[][] fArr5 = nc1.a;
        float[] fArr6 = fArr5[0];
        ...
        if (atan2 < RecyclerView.B1) {
            atan2 += 360.0f;
        } else if (atan2 >= 360.0f) {
            atan2 -= 360.0f;
        }
        float f21 = (3.1415927f * atan2) / 180.0f;
        float pow5 = ((float) Math.pow((f20 * iq7Var.b) / f11, iq7Var.j * f10)) * 100.0f;
        ...
        float pow6 = ((float) Math.pow(1.64d - Math.pow(0.29d, iq7Var.f), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos(((f * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * iq7Var.e) * iq7Var.c) * ((float) Math.sqrt((f17 * f17) + (f16 * f16)))) / (f19 + 0.305f), 0.9d)) * ((float) Math.sqrt(pow5 / 100.0d));
        Math.sqrt((pow * f10) / f22);
        float f23 = (1.7f * pow5) / ((0.007f * pow5) + 1.0f);
        float log = ((float) Math.log((f9 * pow6 * 0.0228f) + 1.0f)) * 43.85965f;
        double d2 = f21;
        return new vb0(atan2, pow6, pow5, f23, log * ((float) Math.cos(d2)), log * ((float) Math.sin(d2)));
    }

    public static vb0 b(float f, float f2, float f3) {
        iq7 iq7Var;
        double d;
        float f4 = iq7.k.d;
        Math.sqrt(f / 100.0d);
        Math.sqrt(((f2 / ((float) Math.sqrt(d))) * iq7Var.d) / (iq7Var.a + 4.0f));
        float f5 = (1.7f * f) / ((0.007f * f) + 1.0f);
        float log = ((float) Math.log((iq7Var.i * f2 * 0.0228d) + 1.0d)) * 43.85965f;
        double d2 = (3.1415927f * f3) / 180.0f;
        return new vb0(f3, f2, f, f5, log * ((float) Math.cos(d2)), log * ((float) Math.sin(d2)));
    }

    public final int c(iq7 iq7Var) {
        float f;
        float[] fArr;
        float f2 = this.b;
        ...
        if (i != 0) {
            ...
            if (d != 0.0d) {
                ...
                float pow2 = iq7Var.a * ((float) Math.pow(f3 / 100.0d, (1.0d / iq7Var.d) / iq7Var.j));
                float cos = ((float) (Math.cos(2.0d + d2) + 3.8d)) * 0.25f * 3846.1538f * iq7Var.e * iq7Var.c;
                float f6 = pow2 / iq7Var.b;
                ...
                return tt0.a(f18, f20 + f19 + (fArr5[0] * f15), (f17 * fArr[2]) + (f16 * fArr[1]) + f21);
            }
        }
        f = RecyclerView.B1;
        float f42 = iq7Var.f;
        ...
        float pow22 = iq7Var.a * ((float) Math.pow(f3 / 100.0d, (1.0d / iq7Var.d) / iq7Var.j));
        float cos3 = ((float) (Math.cos(2.0d + d22) + 3.8d)) * 0.25f * 3846.1538f * iq7Var.e * iq7Var.c;
        float f62 = pow22 / iq7Var.b;
        ...
        return tt0.a(f182, f202 + f192 + (fArr52[0] * f152), (f172 * fArr[2]) + (f162 * fArr[1]) + f212);
    }
}
