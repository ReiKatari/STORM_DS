...
public final class gl5 {
    ...
    public gl5(eg0 eg0Var, HashSet hashSet) {
        Rational rational;
        Size f = k97.f(eg0Var.q().j());
        cg0 q = eg0Var.q();
        m44 m44Var = new m44(q, f);
        this.g = new HashMap();
        this.a = f;
        ...
        kj2.t("ResolutionsMerger", "The closer aspect ratio to the sensor size (" + f + ") is " + rational + ".");
        this.b = rational;
        Rational rational2 = mv.a;
        if (rational.equals(rational2)) {
            rational2 = mv.c;
        } else if (!rational.equals(mv.c)) {
            e41.w(rational, "Invalid sensor aspect-ratio: ");
            throw null;
        }
        this.c = rational2;
        this.f = q;
    ...
    public static Rect a(Size size, Size size2) {
        ...
        if (h2.floatValue() == h3.floatValue()) {
            rectF2 = new RectF(RecyclerView.B1, RecyclerView.B1, width, height);
        } else {
            if (h2.floatValue() > h3.floatValue()) {
                float f = width;
                float floatValue = f / h2.floatValue();
                float f2 = (height - floatValue) / 2.0f;
                rectF = new RectF(RecyclerView.B1, f2, f, floatValue + f2);
            } else {
                float f3 = height;
                float floatValue2 = h2.floatValue() * f3;
                float f4 = (width - floatValue2) / 2.0f;
                rectF = new RectF(f4, RecyclerView.B1, floatValue2 + f4, f3);
            }
            rectF2 = rectF;
        }
        Rect rect = new Rect();
    ...
    public final y15 b(zi7 zi7Var, Rect rect, int i, boolean z) {
        boolean z2;
        Size size;
        Size size2;
        Pair create;
        ...
        if (z) {
            Size f = k97.f(rect);
            Iterator it = c(zi7Var).iterator();
            while (true) {
                if (it.hasNext()) {
                    Size size3 = (Size) it.next();
                    Size f2 = k97.f(a(size3, f));
                    if (!d(f2, f)) {
        ...
        y15 y15Var = new y15(rect, size2, size);
        if (z2) {
            return new y15(new Rect(rect.top, rect.left, rect.bottom, rect.right), new Size(size2.getHeight(), size2.getWidth()), size);
        }
        return y15Var;
    }

    public final List c(zi7 zi7Var) {
        Rational rational;
        if (this.d.contains(zi7Var)) {
            HashMap hashMap = this.g;
            if (hashMap.containsKey(zi7Var)) {
                List list = (List) hashMap.get(zi7Var);
                Objects.requireNonNull(list);
                return list;
            }
            ArrayList u = this.e.u(zi7Var);
            ...
            hashMap.put(zi7Var, arrayList);
            return arrayList;
        }
        e41.w(zi7Var, "Invalid child config: ");
        return null;
    }
    ...
    public final boolean e(Rational rational, Size size) {
        ...
        if (!rational2.equals(rational) && !mv.a(rational, size)) {
            float floatValue = rational2.floatValue();
            float floatValue2 = rational.floatValue();
            Rational rational3 = mv.a;
            if (!mv.a(rational3, size)) {
                rational3 = mv.c;
                if (!mv.a(rational3, size)) {
                    rational3 = h(size);
                }
    ...
    public final ArrayList f(List list, boolean z) {
        ...
        Collections.sort(arrayList2, new ix1(h(this.a), 1));
        ...
        while (i < size3) {
            ...
            if (!rational4.equals(mv.c) && !rational4.equals(mv.a)) {
