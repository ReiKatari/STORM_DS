...
public final class xt {
    ...
    public xt(int i, float f, float f2, float f3, float f4, float f5, float f6) {
        boolean z;
        float f7;
        boolean z2;
        boolean z3;
        ...
        int i3 = 1;
        if (i != 1 && (i == 4 ? f12 <= RecyclerView.B1 : i != 5 || f12 >= RecyclerView.B1)) {
            z = false;
        } else {
            z = true;
        }
