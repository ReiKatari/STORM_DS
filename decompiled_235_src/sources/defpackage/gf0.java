...
public final class gf0 implements Executor, ScheduledExecutorService, AutoCloseable {
    public static final ff0 L = new ff0(0);
    ...
    public final void e(if0 if0Var) {
        ...
        scheduledThreadPoolExecutor.setCorePoolSize(Math.max(1, if0Var.e().size()));
    }
