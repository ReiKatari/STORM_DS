...
public final class qj5 {
    ...
    public qj5(String str, int i, String str2) {
        this.a = i;
        this.b = str;
        this.c = str2;
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof qj5) {
                qj5 qj5Var = (qj5) obj;
                if (this.a != qj5Var.a || !this.b.equals(qj5Var.b) || !this.c.equals(qj5Var.c)) {
                    return false;
                }
                return true;
            }
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("Renderer2DPriorityItem(priority=");
        sb.append(this.a);
        sb.append(", title=");
        sb.append(this.b);
