...
public final class iu4 {
    ...
    public static void a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        ...
        while (i2 < ceil) {
            ...
            path.rLineTo(RecyclerView.B1, RecyclerView.B1);
    ...
    public static void b(iu4[] iu4VarArr, Path path) {
        int i;
        float[] fArr;
        int i2;
        iu4 iu4Var;
        ...
        char c2 = 'm';
        while (i5 < length) {
            iu4 iu4Var3 = iu4VarArr2[i5];
            char c3 = iu4Var3.a;
            float[] fArr3 = iu4Var3.b;
            float f11 = fArr2[i4];
            float f12 = fArr2[1];
            float f13 = fArr2[2];
            float f14 = fArr2[3];
                                            ...
                                            if (c3 != 'h') {
                                                if (c3 != 'q') {
                                                    if (c3 != 'v') {
                                                        ...
                                                        fArr = fArr3;
                                                        i2 = i7;
                                                        path2.rLineTo(RecyclerView.B1, fArr[i2]);
                                                        f6 = fArr[i2];
                                                    }
                                                    f20 += f6;
                                                } else {
                                                ...
                                                fArr = fArr3;
                                                i2 = i7;
                                                path2.rLineTo(fArr[i2], RecyclerView.B1);
                                                f19 += fArr[i2];
                                            }
                                        } else {
                                            fArr = fArr3;
            ...
            c2 = iu4Var3.a;
            i5++;
            iu4VarArr2 = iu4VarArr;
            path2 = path;
            i4 = i6;
        }
    }

    public iu4(char c, float[] fArr) {
        this.a = c;
        this.b = fArr;
    }
}
