...
public final class a {
    ...
    public final void a() {
        ...
        if (!motionLayout.isAttachedToWindow()) {
            if (motionLayout.j1 == null) {
                motionLayout.j1 = new a(motionLayout);
            }
            a aVar = motionLayout.j1;
            aVar.a = f;
            aVar.b = f2;
        } else {
            ...
            int i3 = (f2 > RecyclerView.B1 ? 1 : (f2 == RecyclerView.B1 ? 0 : -1));
            if (i3 != 0) {
                if (i3 > 0) {
                    f3 = 1.0f;
                }
                motionLayout.p(f3);
            } else if (f != RecyclerView.B1 && f != 1.0f) {
                if (f > 0.5f) {
                    f3 = 1.0f;
                }
                motionLayout.p(f3);
