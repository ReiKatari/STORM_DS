...
public final class x {
    ...
    public x(yc1 yc1Var, y yVar, ClassLoader classLoader, gl2 gl2Var, Bundle bundle) {
        this.a = yc1Var;
        this.b = yVar;
        ...
        a.mTag = wVar.Z;
        a.mRetainInstance = wVar.d0;
        a.mRemoving = wVar.e0;
        a.mDetached = wVar.f0;
        a.mHidden = wVar.g0;
        a.mMaxState = tt3.values()[wVar.h0];
        a.mTargetWho = wVar.i0;
        a.mTargetRequestCode = wVar.j0;
        a.mUserVisibleHint = wVar.k0;
        this.c = a;
    ...
    public final void b() {
        ...
        if (oVar != null && !oVar.equals(parentFragment)) {
            ...
            tl2.b(new jq7(oVar3, lb1.o(sb, i, " without using parent's childFragmentManager")));
            tl2.a(oVar3).getClass();
    ...
    public final void c() {
        ...
        if (oVar2 != null) {
            ...
            if (str != null && (xVar = (x) yVar.b.get(str)) == null) {
                ...
                defpackage.i.m(i61.n(sb2, oVar.mTargetWho, " that does not belong to this FragmentManager!"));
                return;
            }
        }
        if (xVar != null) {
    ...
    public final int d() {
        ...
        int i2 = this.e;
        int i3 = ql2.a[oVar.mMaxState.ordinal()];
        if (i3 != 1) {
            if (i3 != 2) {
                if (i3 != 3) {
                    if (i3 != 4) {
        ...
        if (viewGroup != null) {
            ...
            if (xn6Var == null) {
                ...
                i = co6.a[xn6Var.ordinal()];
            }
            if (i != -1 && i != 1) {
                xn6Var2 = xn6Var;
            }
        }
        if (xn6Var2 == xn6.ADDING) {
            i2 = Math.min(i2, 6);
        } else if (xn6Var2 == xn6.REMOVING) {
            i2 = Math.max(i2, 3);
    ...
    public final void f() {
            ...
            if (i != 0) {
                if (i != -1) {
                    ...
                    if (viewGroup == null) {
                        ...
                        sl2 sl2Var = tl2.a;
                        tl2.b(new jq7(oVar, "Attempting to add fragment " + oVar + " to container " + viewGroup + " which is not a FragmentContainerView"));
                        tl2.a(oVar).getClass();
                        rl2 rl2Var = rl2.PENALTY_LOG;
                    }
                } else {
                    defpackage.i.h(lb1.l("Cannot create fragment ", oVar, " for a container view with no id"));
                    return;
                }
            }
        }
        ...
        if (oVar.mView != null) {
            ...
            if (isAttachedToWindow) {
                ...
                view.addOnAttachStateChangeListener(new wh(view, 3));
            }
            oVar.performViewCreated();
            this.a.B(oVar, oVar.mView, false);
            ...
            if (oVar.mContainer != null && visibility == 0) {
                ...
                oVar.mView.setAlpha(RecyclerView.B1);
            }
        }
        oVar.mState = 2;
    }
    ...
    public final void g() {
        ...
        if (cl2Var instanceof bp7) {
            z3 = yVar.d.f;
        } else {
            jq jqVar = cl2Var.B;
            if (jqVar != null) {
                z3 = true ^ jqVar.isChangingConfigurations();
            }
        }
                        ...
                        switch (i + 1) {
                            ...
                            case 4:
                                if (oVar.mView != null && (viewGroup3 = oVar.mContainer) != null) {
                                    ...
                                    ao6 from = ao6.from(oVar.mView.getVisibility());
                                    from.getClass();
                                    if (u.K(2)) {
                                        Log.v("FragmentManager", "SpecialEffectsController: Enqueuing add operation for fragment " + oVar);
                                    }
                                    j.d(from, xn6.ADDING, this);
                                }
                                oVar.mState = 4;
                                continue;
                            case 5:
                        ...
                        switch (i - 1) {
                            ...
                            case 3:
                                ...
                                if (oVar.mView != null && (viewGroup2 = oVar.mContainer) != null) {
                                    ...
                                    j2.d(ao6.REMOVED, xn6.REMOVING, this);
                                }
                                oVar.mState = 3;
                                continue;
                            case 4:
                    ...
                    if (oVar.mHiddenChanged) {
                        if (oVar.mView != null && (viewGroup = oVar.mContainer) != null) {
                            ...
                            if (oVar.mHidden) {
                                ...
                                j3.d(ao6.GONE, xn6.NONE, this);
                            } else {
                                if (u.K(2)) {
                                    Log.v("FragmentManager", "SpecialEffectsController: Enqueuing show operation for fragment " + oVar);
                                }
                                j3.d(ao6.VISIBLE, xn6.NONE, this);
                            }
                        }
                        u uVar = oVar.mFragmentManager;
    ...
    public x(yc1 yc1Var, y yVar, o oVar) {
        this.a = yc1Var;
        this.b = yVar;
        this.c = oVar;
    }

    public x(yc1 yc1Var, y yVar, o oVar, Bundle bundle) {
        this.a = yc1Var;
        this.b = yVar;
        this.c = oVar;
        oVar.mSavedViewState = null;
