...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, m75.a);
        boolean z = false;
        this.R = obtainStyledAttributes.getDrawable(0);
        this.d0 = obtainStyledAttributes.getDrawable(2);
        this.h0 = obtainStyledAttributes.getDimensionPixelSize(13, -1);
        if (getId() == R.id.split_action_bar) {
            this.f0 = true;
            this.e0 = obtainStyledAttributes.getDrawable(1);
        }
        obtainStyledAttributes.recycle();
        if (!this.f0 ? !(this.R != null || this.d0 != null) : this.e0 == null) {
            z = true;
        }
        setWillNotDraw(z);
    }
    ...
    public final void onMeasure(int i, int i2) {
        int i3;
        if (this.B == null && View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE && (i3 = this.h0) >= 0) {
    ...
    public void setSplitBackground(Drawable drawable) {
        ...
        if (drawable != null) {
            drawable.setCallback(this);
            if (z && (drawable2 = this.e0) != null) {
                drawable2.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
            }
        }
        if (!z ? !(this.R != null || this.d0 != null) : this.e0 == null) {
            z2 = true;
        }
        setWillNotDraw(z2);
        invalidate();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        ...
        if (drawable != drawable2 || z) {
            if (drawable != this.d0 || !this.g0) {
                if ((drawable == this.e0 && z) || super.verifyDrawable(drawable)) {
                    return true;
                }
                return false;
            }
    ...
    public void setTabContainer(n86 n86Var) {
    }
}
