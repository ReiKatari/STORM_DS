...
final class zzcz implements rh4 {
    ...
    static {
        ...
        zzd = new qh4() { // from class: com.google.android.gms.internal.mlkit_vision_text_common.zzcy
            @Override // defpackage.y32
            public final void encode(Object obj, Object obj2) {
                zzcz.zzg((Map.Entry) obj, (rh4) obj2);
            }
        };
    }

    public zzcz(OutputStream outputStream, Map map, Map map2, qh4 qh4Var) {
    ...
    private static int zzh(na2 na2Var) {
        zzcx zzcxVar = (zzcx) na2Var.b(zzcx.class);
        if (zzcxVar != null) {
            return zzcxVar.zza();
        }
    ...
    private static zzcx zzj(na2 na2Var) {
        zzcx zzcxVar = (zzcx) na2Var.b(zzcx.class);
        if (zzcxVar != null) {
            return zzcxVar;
        }
    ...
    private final zzcz zzk(qh4 qh4Var, na2 na2Var, Object obj, boolean z) {
    ...
    private final zzcz zzl(lk7 lk7Var, na2 na2Var, Object obj, boolean z) {
    ...
    public final zzcz zzd(na2 na2Var, int i, boolean z) {
        if (!z || i != 0) {
            zzcx zzj = zzj(na2Var);
    ...
    public final zzcz zze(na2 na2Var, long j, boolean z) {
        if (!z || j != 0) {
            zzcx zzj = zzj(na2Var);
            int ordinal = zzj.zzb().ordinal();
            if (ordinal != 0) {
