...
public enum zzmu implements zzba {
    ...
    URI_EXPIRED(MlKitException.NOT_ENOUGH_SPACE),
    NO_NETWORK_CONNECTION(MlKitException.MODEL_HASH_MISMATCH),
    METERED_NETWORK(103),
    DOWNLOAD_FAILED(104),
    ...
    CODE_SCANNER_TASK_IN_PROGRESS(Compress.HUFF_TABLE_SIZE),
