...
final class zzbe implements rh4 {
    ...
    static {
        ...
        zzd = new qh4() { // from class: com.google.android.gms.internal.mlkit_common.zzbd
            @Override // defpackage.y32
            public final void encode(Object obj, Object obj2) {
                zzbe.zzg((Map.Entry) obj, (rh4) obj2);
            }
        };
    }

    public zzbe(OutputStream outputStream, Map map, Map map2, qh4 qh4Var) {
    ...
    private static int zzh(na2 na2Var) {
        zzbc zzbcVar = (zzbc) na2Var.b(zzbc.class);
        if (zzbcVar != null) {
            return zzbcVar.zza();
        }
    ...
    private static zzbc zzj(na2 na2Var) {
        zzbc zzbcVar = (zzbc) na2Var.b(zzbc.class);
        if (zzbcVar != null) {
            return zzbcVar;
        }
    ...
    private final zzbe zzk(qh4 qh4Var, na2 na2Var, Object obj, boolean z) {
    ...
    private final zzbe zzl(lk7 lk7Var, na2 na2Var, Object obj, boolean z) {
    ...
    public final zzbe zzd(na2 na2Var, int i, boolean z) {
        if (!z || i != 0) {
            zzbc zzj = zzj(na2Var);
    ...
    public final zzbe zze(na2 na2Var, long j, boolean z) {
        if (!z || j != 0) {
            zzbc zzj = zzj(na2Var);
            int ordinal = zzj.zzb().ordinal();
            if (ordinal != 0) {
