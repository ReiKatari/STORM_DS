...
final class zzgp implements qh4 {
    ...
    static {
        ...
        zzb = new na2("deviceInfo", xg6.u(hashMap));
        zzai j2 = xg6.j(2);
        HashMap hashMap2 = new HashMap();
        hashMap2.put(j2.annotationType(), j2);
        zzc = new na2("nnapiInfo", xg6.u(hashMap2));
        zzai j3 = xg6.j(3);
        HashMap hashMap3 = new HashMap();
        hashMap3.put(j3.annotationType(), j3);
        zzd = new na2("gpuInfo", xg6.u(hashMap3));
        zzai j4 = xg6.j(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(j4.annotationType(), j4);
        zze = new na2("pipelineIdentifier", xg6.u(hashMap4));
        zzai j5 = xg6.j(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(j5.annotationType(), j5);
        zzf = new na2("acceptedConfigurations", xg6.u(hashMap5));
        zzai j6 = xg6.j(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(j6.annotationType(), j6);
        zzg = new na2("action", xg6.u(hashMap6));
        zzai j7 = xg6.j(7);
        HashMap hashMap7 = new HashMap();
        hashMap7.put(j7.annotationType(), j7);
        zzh = new na2("status", xg6.u(hashMap7));
        zzai j8 = xg6.j(8);
        HashMap hashMap8 = new HashMap();
        hashMap8.put(j8.annotationType(), j8);
        zzi = new na2("customErrors", xg6.u(hashMap8));
        zzai j9 = xg6.j(9);
        HashMap hashMap9 = new HashMap();
        hashMap9.put(j9.annotationType(), j9);
        zzj = new na2("benchmarkStatus", xg6.u(hashMap9));
        zzai j10 = xg6.j(10);
        HashMap hashMap10 = new HashMap();
        hashMap10.put(j10.annotationType(), j10);
        zzk = new na2("validationTestResult", xg6.u(hashMap10));
        zzai j11 = xg6.j(11);
        HashMap hashMap11 = new HashMap();
        hashMap11.put(j11.annotationType(), j11);
        zzl = new na2("timestampUs", xg6.u(hashMap11));
        zzai j12 = xg6.j(12);
        HashMap hashMap12 = new HashMap();
        hashMap12.put(j12.annotationType(), j12);
        zzm = new na2("elapsedUs", xg6.u(hashMap12));
    }
