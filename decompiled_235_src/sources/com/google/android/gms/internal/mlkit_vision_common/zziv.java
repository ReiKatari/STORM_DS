...
public enum zziv implements zzag {
    ...
    CUSTOM_MODEL_RUN(MlKitException.MODEL_HASH_MISMATCH),
    ...
    MODEL_DOWNLOAD(100),
    MODEL_UPDATE(MlKitException.NOT_ENOUGH_SPACE),
    ...
    AGGREGATED_AUTO_ML_IMAGE_LABELING_INFERENCE(MlKitException.CODE_SCANNER_UNAVAILABLE),
    ...
    INSTALLATION_ID_FIS_CREATE_INSTALLATION(MlKitException.LOW_LIGHT_IMAGE_CAPTURE_PROCESSING_FAILURE),
    ...
    OPTIONAL_MODULE_LANGUAGE_ID_INFERENCE(Compress.HUFF_TABLE_SIZE),
