...
final class zzdq implements qh4 {
    ...
    static {
        ...
        zzd = new na2("inputsFormats", xg6.u(hashMap3));
        zzai j4 = xg6.j(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(j4.annotationType(), j4);
        zze = new na2("outputFormats", xg6.u(hashMap4));
        zzai j5 = xg6.j(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(j5.annotationType(), j5);
        zzf = new na2("modelInitializationMs", xg6.u(hashMap5));
    }
