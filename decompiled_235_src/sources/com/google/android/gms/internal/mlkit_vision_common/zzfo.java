...
final class zzfo implements qh4 {
    ...
    static {
        ...
        zzb = new na2("detectorOptions", xg6.u(hashMap));
        zzai j2 = xg6.j(2);
        HashMap hashMap2 = new HashMap();
        hashMap2.put(j2.annotationType(), j2);
        zzc = new na2("errorCodes", xg6.u(hashMap2));
        zzai j3 = xg6.j(3);
        HashMap hashMap3 = new HashMap();
        hashMap3.put(j3.annotationType(), j3);
        zzd = new na2("totalInitializationMs", xg6.u(hashMap3));
        zzai j4 = xg6.j(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(j4.annotationType(), j4);
        zze = new na2("loggingInitializationMs", xg6.u(hashMap4));
        zzai j5 = xg6.j(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(j5.annotationType(), j5);
        zzf = new na2("otherErrors", xg6.u(hashMap5));
    }
