...
final class zzem implements qh4 {
    ...
    static {
        ...
        zzb = new na2("identifyLanguageConfidenceThreshold", xg6.u(hashMap));
        zzai j2 = xg6.j(2);
        HashMap hashMap2 = new HashMap();
        hashMap2.put(j2.annotationType(), j2);
        zzc = new na2("identifyAllLanguagesConfidenceThreshold", xg6.u(hashMap2));
        zzai j3 = xg6.j(3);
        HashMap hashMap3 = new HashMap();
        hashMap3.put(j3.annotationType(), j3);
        zzd = new na2("confidenceThreshold", xg6.u(hashMap3));
    }
