...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    @ResultIgnorabilityUnspecified
    public static boolean showErrorDialogFragment(int i, Activity activity, o oVar, int i2, DialogInterface.OnCancelListener onCancelListener) {
        if (true == GooglePlayServicesUtilLight.isPlayServicesPossiblyUpdating(activity, i)) {
            i = 18;
        }
        int i3 = i;
        ...
        Dialog zaa = googleApiAvailability.zaa(activity, i3, zag.zac(oVar, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i3, "d"), i2), onCancelListener, null);
        if (zaa == null) {
            return false;
        }
