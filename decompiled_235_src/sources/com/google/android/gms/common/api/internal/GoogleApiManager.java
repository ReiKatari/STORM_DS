...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final Set zap = new zu(0);
    private final Set zaq = new zu(0);

    private GoogleApiManager(Context context, Looper looper, GoogleApiAvailability googleApiAvailability) {
        this.zas = true;
        this.zai = context;
        b08 b08Var = new b08(looper, this);
        this.zar = b08Var;
        ...
        b08Var.sendMessage(b08Var.obtainMessage(6));
    }
        ...
        switch (i) {
            ...
            case 5:
                ...
                if (zabqVar != null) {
                    ...
                    Log.wtf("GoogleApiManager", lb1.k("Could not find API instance ", i2, " while trying to fail enqueued calls."), new Exception());
                    break;
                }
            case 6:
