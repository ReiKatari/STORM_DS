...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    private final void zal(int i) {
        ...
        if (num == null) {
            ...
            e41.r("Cannot use sign-in mode: ", zag(i), ". Mode was already set to ", zag(this.zaw.intValue()));
            return;
        }
        if (this.zal != null) {
            return;
        ...
        if (intValue != 1) {
            ...
            if (z) {
                if (z2) {
                    i.m("Cannot use SIGN_IN_MODE_REQUIRED with GOOGLE_SIGN_IN_API. Use connect(SIGN_IN_MODE_OPTIONAL) instead.");
                    return;
                }
            } else {
                i.m("SIGN_IN_MODE_REQUIRED cannot be used on a GoogleApiClient that does not contain any authenticated APIs. Use connect() instead.");
                return;
            }
        }
    ...
    public final void stopAutoManage(p pVar) {
        ...
        if (this.zam >= 0) {
            ...
            i.m("Called stopAutoManage but automatic lifecycle management is not enabled.");
        }
    }
