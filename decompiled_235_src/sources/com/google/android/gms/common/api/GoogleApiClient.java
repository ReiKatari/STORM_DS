...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        /* JADX WARN: Type inference failed for: r0v2, types: [ci6, java.util.Map] */
        /* JADX WARN: Type inference failed for: r0v3, types: [ci6, java.util.Map] */
        ...
        /* JADX WARN: Type inference failed for: r11v0, types: [ci6, java.util.Map] */
        /* JADX WARN: Type inference failed for: r14v0, types: [ci6, java.util.Map, wu] */
        @ResultIgnorabilityUnspecified
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                ci6Var.put(api2, Boolean.valueOf(z));
                ...
                ci6Var2.put(api2.zab(), buildClient);
                ...
                if (buildClient.providesSignIn()) {
                    if (api == null) {
                        ...
                        i.m(lb1.m(api2.zad(), " cannot be used with ", api.zad()));
                        return null;
                    }
                }
            }
            if (api != null) {
                if (!z3) {
                    ...
                    i.m(lb1.A("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                    return null;
                }
            }
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, zaa, this.zao, this.zap, ci6Var, this.zaq, this.zar, ci6Var2, this.zal, zabe.zad(ci6Var2.values(), true), arrayList);
        ...
        public Builder enableAutoManage(p pVar, int i, OnConnectionFailedListener onConnectionFailedListener) {
            boolean z;
            LifecycleActivity lifecycleActivity = new LifecycleActivity((Activity) pVar);
            if (i >= 0) {
                z = true;
            } else {
                z = false;
        ...
        public final ClientSettings zaa() {
            ...
            if (map.containsKey(api)) {
                bi6Var = (bi6) this.zaj.get(api);
            } else {
                bi6Var = bi6.a;
            }
            return new ClientSettings(this.zaa, this.zab, this.zah, this.zad, this.zae, this.zaf, this.zag, bi6Var, false);
        }
        ...
        public Builder enableAutoManage(p pVar, OnConnectionFailedListener onConnectionFailedListener) {
            enableAutoManage(pVar, 0, onConnectionFailedListener);
            return this;
        }
