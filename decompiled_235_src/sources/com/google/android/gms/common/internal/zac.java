...
public final class zac {
    private static final ci6 zaa = new ci6(0);
    ...
    private static String zah(Context context, String str) {
        ...
        synchronized (ci6Var) {
            try {
                Locale b = new hy3(new iy3(context.getResources().getConfiguration().getLocales())).b(0);
                if (!b.equals(zab)) {
                    ci6Var.clear();
                    zab = b;
                }
                String str2 = (String) ci6Var.get(str);
                if (str2 != null) {
                    return str2;
                }
