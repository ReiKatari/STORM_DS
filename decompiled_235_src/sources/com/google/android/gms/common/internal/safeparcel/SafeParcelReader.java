...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        ...
        throw new ParseException(lb1.g(i, "Overread allowed size end="), parcel);
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        if (fieldId == 20293) {
            ...
            throw new ParseException(lb1.j("Size read is invalid start=", dataPosition, i, " end="), parcel);
        }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        ...
        throw new ParseException(i61.n(i61.q(i3, i2, "Expected size ", " got ", " (0x"), Integer.toHexString(i2), ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i, int i2) {
        ...
        throw new ParseException(i61.n(i61.q(i2, readSize, "Expected size ", " got ", " (0x"), Integer.toHexString(readSize), ")"), parcel);
    }
}
