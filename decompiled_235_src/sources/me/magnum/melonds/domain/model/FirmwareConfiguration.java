...
public final class FirmwareConfiguration {
    ...
    public int hashCode() {
        int hashCode;
        int e = xg6.e(lb1.a(this.birthdayDay, lb1.a(this.birthdayMonth, lb1.a(this.favouriteColour, lb1.a(this.language, xg6.d(this.nickname.hashCode() * 31, 31, this.message), 31), 31), 31), 31), this.randomizeMacAddress, 31);
    ...
    public String toString() {
        ...
        StringBuilder u = i61.u("FirmwareConfiguration(nickname=", str, ", message=", str2, ", language=");
        lb1.x(u, i, ", favouriteColour=", i2, ", birthdayMonth=");
        lb1.x(u, i3, ", birthdayDay=", i4, ", randomizeMacAddress=");
        u.append(z);
        u.append(", internalMacAddress=");
        u.append(str3);
        u.append(")");
        return u.toString();
    }
