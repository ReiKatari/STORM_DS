...
public final class VulkanPresentationConfig {
    ...
    public boolean equals(Object obj) {
        ...
        if (nb3.k(this.topScreenRect, vulkanPresentationConfig.topScreenRect) && nb3.k(this.bottomScreenRect, vulkanPresentationConfig.bottomScreenRect) && Float.compare(this.topAlpha, vulkanPresentationConfig.topAlpha) == 0 && Float.compare(this.bottomAlpha, vulkanPresentationConfig.bottomAlpha) == 0 && this.topOnTop == vulkanPresentationConfig.topOnTop && this.bottomOnTop == vulkanPresentationConfig.bottomOnTop && nb3.k(this.hybridTopScreenRect, vulkanPresentationConfig.hybridTopScreenRect) && nb3.k(this.hybridBottomScreenRect, vulkanPresentationConfig.hybridBottomScreenRect) && Float.compare(this.hybridAlpha, vulkanPresentationConfig.hybridAlpha) == 0 && this.hybridOnTop == vulkanPresentationConfig.hybridOnTop && this.backgroundMode == vulkanPresentationConfig.backgroundMode && this.videoFiltering == vulkanPresentationConfig.videoFiltering && this.retroShaderEnabled == vulkanPresentationConfig.retroShaderEnabled && nb3.k(this.retroShaderPresetPath, vulkanPresentationConfig.retroShaderPresetPath) && nb3.k(this.retroShaderSourceResolution, vulkanPresentationConfig.retroShaderSourceResolution) && this.retroShaderPassCount == vulkanPresentationConfig.retroShaderPassCount && nb3.k(this.retroShaderParameterOverrides, vulkanPresentationConfig.retroShaderParameterOverrides) && this.retroShaderClearHistory == vulkanPresentationConfig.retroShaderClearHistory) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int e = xg6.e(xg6.e(xg6.a(this.bottomAlpha, xg6.a(this.topAlpha, (i2 + hashCode2) * 31, 31), 31), this.topOnTop, 31), this.bottomOnTop, 31);
        ...
        int e2 = xg6.e((this.videoFiltering.hashCode() + ((this.backgroundMode.hashCode() + xg6.e(xg6.a(this.hybridAlpha, (i3 + hashCode4) * 31, 31), this.hybridOnTop, 31)) * 31)) * 31, this.retroShaderEnabled, 31);
        String str = this.retroShaderPresetPath;
        if (str != null) {
            i = str.hashCode();
        }
        return Boolean.hashCode(this.retroShaderClearHistory) + ((this.retroShaderParameterOverrides.hashCode() + lb1.a(this.retroShaderPassCount, xg6.d((e2 + i) * 31, 31, this.retroShaderSourceResolution), 31)) * 31);
    }
