...
public abstract class Hilt_AboutPreferencesFragment extends BasePreferenceFragment implements kr2 {
    public bo7 B;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.Y) {
            ...
            ((AboutPreferencesFragment_GeneratedInjector) c()).getClass();
        }
    }
