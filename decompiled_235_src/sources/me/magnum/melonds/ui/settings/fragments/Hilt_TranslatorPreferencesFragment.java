...
public abstract class Hilt_TranslatorPreferencesFragment extends BasePreferenceFragment implements kr2 {
    public bo7 B;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.Y) {
            this.Y = true;
            TranslatorPreferencesFragment translatorPreferencesFragment = (TranslatorPreferencesFragment) this;
            ((TranslatorPreferencesFragment_GeneratedInjector) c()).getClass();
        }
    }
