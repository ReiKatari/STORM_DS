...
public abstract class Hilt_VideoPreferencesFragment extends BasePreferenceFragment implements kr2 {
    public bo7 B;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.Y) {
            this.Y = true;
            ((VideoPreferencesFragment_GeneratedInjector) c()).i((VideoPreferencesFragment) this);
        }
    }
