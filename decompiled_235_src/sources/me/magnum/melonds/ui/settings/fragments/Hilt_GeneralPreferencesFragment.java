...
public abstract class Hilt_GeneralPreferencesFragment extends BasePreferenceFragment implements kr2 {
    public bo7 B;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.Y) {
            this.Y = true;
            ((GeneralPreferencesFragment_GeneratedInjector) c()).c((GeneralPreferencesFragment) this);
        }
    }
