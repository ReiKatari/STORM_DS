...
public abstract class Hilt_SystemPreferencesFragment extends BasePreferenceFragment implements kr2 {
    public bo7 B;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.Y) {
            this.Y = true;
            ((SystemPreferencesFragment_GeneratedInjector) c()).a((SystemPreferencesFragment) this);
        }
    }
