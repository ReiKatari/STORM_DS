...
public abstract class Hilt_CheatsPreferencesFragment extends BasePreferenceFragment implements kr2 {
    public bo7 B;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.Y) {
            ...
            ((CheatsPreferencesFragment_GeneratedInjector) c()).getClass();
        }
    }
