...
public abstract class Hilt_InputPreferencesFragment extends BasePreferenceFragment implements kr2 {
    public bo7 B;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.Y) {
            this.Y = true;
            ((InputPreferencesFragment_GeneratedInjector) c()).g((InputPreferencesFragment) this);
        }
    }
