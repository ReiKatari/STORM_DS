...
public abstract class Hilt_CustomFirmwarePreferencesFragment extends BasePreferenceFragment implements kr2 {
    public bo7 B;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.Y) {
            this.Y = true;
            ((CustomFirmwarePreferencesFragment_GeneratedInjector) c()).b((CustomFirmwarePreferencesFragment) this);
        }
    }
