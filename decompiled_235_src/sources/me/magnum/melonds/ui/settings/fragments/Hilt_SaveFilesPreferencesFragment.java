...
public abstract class Hilt_SaveFilesPreferencesFragment extends BasePreferenceFragment implements kr2 {
    public bo7 B;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.Y) {
            this.Y = true;
            ((SaveFilesPreferencesFragment_GeneratedInjector) c()).e((SaveFilesPreferencesFragment) this);
        }
    }
