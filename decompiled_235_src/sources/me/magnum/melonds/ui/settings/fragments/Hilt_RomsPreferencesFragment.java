...
public abstract class Hilt_RomsPreferencesFragment extends BasePreferenceFragment implements kr2 {
    public bo7 B;
    ...
    public final void onAttach(Activity activity) {
        ...
        if (!this.Y) {
            this.Y = true;
            ((RomsPreferencesFragment_GeneratedInjector) c()).d((RomsPreferencesFragment) this);
        }
    }
