...
@mc1(c = "me.magnum.melonds.ui.settings.fragments.CustomFirmwarePreferencesFragment$onCreatePreferences$1$1", f = "CustomFirmwarePreferencesFragment.kt", l = {63}, m = "invokeSuspend", v = 2)
/* loaded from: classes.dex */
final class CustomFirmwarePreferencesFragment$onCreatePreferences$1$1 extends hw6 implements eo2 {
    public int X;
    ...
    public CustomFirmwarePreferencesFragment$onCreatePreferences$1$1(CustomFirmwarePreferencesFragment customFirmwarePreferencesFragment, ProgressDialog progressDialog, BiosDirectoryPickerPreference biosDirectoryPickerPreference, r41 r41Var) {
        super(2, r41Var);
    ...
    public final Object o(Object obj, Object obj2) {
        return ((CustomFirmwarePreferencesFragment$onCreatePreferences$1$1) q((r41) obj2, (w61) obj)).s(jg7.a);
    }

    @Override // defpackage.d20
    public final r41 q(r41 r41Var, Object obj) {
        return new CustomFirmwarePreferencesFragment$onCreatePreferences$1$1(this.Y, this.Z, this.d0, r41Var);
    }
    ...
    public final Object s(Object obj) {
        ...
        if (i != 0) {
            ...
            if (m40Var != null) {
                i81 i81Var = new i81(customFirmwarePreferencesFragment, progressDialog, 0);
                this.X = 1;
                e = m40Var.e(i81Var, this);
                if (e == x61Var) {
                    return x61Var;
                }
            } else {
        ...
        if (!(e instanceof em5)) {
            ...
            wb wbVar = (wb) zbVar.L;
            wbVar.d = "Успешно";
            wbVar.f = i61.m("Файлы BIOS DS (bios7.bin, bios9.bin, firmware.bin) успешно скачаны и настроены!\n\nПапка: ", file.getAbsolutePath());
            ...
            wbVar2.f = i61.m("Не удалось скачать файлы BIOS: ", str);
